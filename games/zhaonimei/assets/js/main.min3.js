...
shareData = {
    imgUrl: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/zhaonimei/",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,

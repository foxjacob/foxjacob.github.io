			...
			e = new Class({
			    ...
			    gameOver: function () {
			        2 != App.gameStat && (App.gameStat = 2, lib.each(this.tracks,
						...
						// updateShare(App.score);
						// Play68.setRankingScoreDesc(App.score);
			    },
			    sendScore: function () {
			        var t = {
			            score: App.score,
	    ...
	    var t = BaseUI.extend({
	        ...
	        render: function () {
				...
				t.getMaxScore() > 0 && new Panel("span", {
				    "class": "text-span"
				}).set("html", "你的成绩：" + t.getMaxScore() + "层").inject(e),
	...
	Result = function () {
	    ...
	    return t = BaseUI.extend({
	        ...
	        render: function () {
	            ...
	            // }).inject(n)),
				isInWeiXin() || isTouch && !_get.f ? (lib.addClass(this.restartBtn, "touch"), this.shareBtn) : lib.removeClass(this.restartBtn, "touch"),
            ...
            */
	        ...
	        attach: function () {
				...
				this.shareBtn.addEvent("fastclick", this.share),
				this.xyyxBtn.addEvent("fastclick", clickMore),

...
(function() {
    ...
    v.prototype.loadTexture = function(e, t, n, r, i) {
        ...
        } else u.texImage2D(u.TEXTURE_2D, 0, f, l, c, e); if (t) {
            if (i === "repeat-x") {
...
(function() {
    ...
    e.prototype.go_textures_done = function() {
        ...
        else this.layouts_by_index[0].startRunning(); if (!this.uses_loader_layout) {
    ...
    e.prototype.tick = function() {
        ...
        if ((this.redraw || this.isCocoonJs) && !this.is_WebGL_context_lost && !this.suspendDrawing) {
            ...
            else this.draw(); if (this.snapshotCanvas) {
            ...
            if (!this.testOverlap(e, l)) {
                ...
                if (!l) {
                    if (i) {
                        ...
                        else l = this.testOverlapJumpThru(e); if (l) c = l
                    }
                    if (!l) {
...
(function() {
    ...
    function a(e, t) {
        ...
        if (t[0] === -1) {
            ...
            else this.run = this.run_object; if (t[2]) {
        ...
        if (f.select_all) {
            ...
            for (e = 0, n = v.length; e < n; e++) {
                ...
                if (this.beh_index > -1) {
                    ...
                    i = this.func.apply(o.behavior_insts[this.beh_index + c], this.results)
                } else i = this.func.apply(o, this.results); if (cr.xor(i, this.inverted)) {
                    m = true;
                    if (d) {
                        f.instances.push(o);
                        if (h) {
...
(function() {
    ...
    n.onCreate = function() {
        ...
        if (!this.runtime.isDomFree) {
            ...
            document.addEventListener("mousewheel", t, false);
    ...
    o.prototype.X = function(e, t) {
        ...
        if (cr.is_undefined(t)) {
            ...
            else n = this.runtime.getLayerByName(t); if (n) e.set_float(n.canvasToLayer(this.mouseXcanvas, this.mouseYcanvas, true));
            else e.set_float(0)
        }
    };
    o.prototype.Y = function(e, t) {
        ...
        if (cr.is_undefined(t)) {
            ...
            if (cr.is_number(t)) n = this.runtime.getLayerByNumber(t);
            else n = this.runtime.getLayerByName(t); if (n) e.set_float(n.canvasToLayer(this.mouseXcanvas, this.mouseYcanvas, false));
            else e.set_float(0)
        }
    };
...
(function() {
    ...
    i.prototype.gameOver = function() {
        ...
        if (window.c2_score > getHighScore()) {
            localStorage[gameID + "high_score"] = window.c2_score; /*updateShare(window.c2_score);Play68.setRankingScoreDesc(window.c2_score)*/
        }
    };
    ...
    g.prototype.Spawn = function(e, t, n) {
        ...
        if (e != this.type) {
            ...
            if (a) {
                ...
                f.instances[0] = r
            } else f.instances.push(r); if (r.is_contained) {
                for (i = 0, s = r.siblings.length; i < s; i++) {
                    o = r.siblings[i];
...
(function() {
    ...
    n.onCreate = function() {
        ...
        else this.rcTex = new cr.rect(0, 0, 1, 1); if (this.runtime.glwrap) this.runtime.tickMe(this);
    };
...
(function() {
    ...
    v.prototype.X = function(e, t) {
        if (this.touches.length) {
            ...
            if (cr.is_undefined(t)) {
                ...
                if (cr.is_number(t)) n = this.runtime.getLayerByNumber(t);
                else n = this.runtime.getLayerByName(t); if (n) e.set_float(n.canvasToLayer(this.touches[0].x, this.touches[0].y, true));
                else e.set_float(0)
            }
        } else e.set_float(0)
    };
    v.prototype.XAt = function(e, t, n) {
        ...
        if (cr.is_undefined(n)) {
            ...
            else r = this.runtime.getLayerByName(n); if (r) e.set_float(r.canvasToLayer(this.touches[t].x, this.touches[t].y, true));
            else e.set_float(0)
        }
    };
    v.prototype.XForID = function(e, t, n) {
        ...
        if (cr.is_undefined(n)) {
            ...
            else s = this.runtime.getLayerByName(n); if (s) e.set_float(s.canvasToLayer(i.x, i.y, true));
            else e.set_float(0)
        }
    };
    v.prototype.Y = function(e, t) {
        if (this.touches.length) {
            ...
            if (cr.is_undefined(t)) {
                ...
                if (cr.is_number(t)) n = this.runtime.getLayerByNumber(t);
                else n = this.runtime.getLayerByName(t); if (n) e.set_float(n.canvasToLayer(this.touches[0].x, this.touches[0].y, false));
                else e.set_float(0)
            }
        } else e.set_float(0)
    };
    v.prototype.YAt = function(e, t, n) {
        ...
        if (cr.is_undefined(n)) {
            ...
            if (cr.is_number(n)) r = this.runtime.getLayerByNumber(n);
            else r = this.runtime.getLayerByName(n); if (r) e.set_float(r.canvasToLayer(this.touches[t].x, this.touches[t].y, false));
            else e.set_float(0)
        }
    };
    v.prototype.YForID = function(e, t, n) {
        ...
        if (cr.is_undefined(n)) {
            ...
            if (cr.is_number(n)) s = this.runtime.getLayerByNumber(n);
            else s = this.runtime.getLayerByName(n); if (s) e.set_float(s.canvasToLayer(i.x, i.y, false));
            else e.set_float(0)
        }
    };
...
(function() {
    ...
    for (var f = 0; f <= litetween_precision; f++) {
        ...
        if (s == 0 || s < Math.abs(r)) {
            s = r;
            var a = o / 4
        } else var a = o / (2 * Math.PI) * Math.asin(r / s); if (u < 1) i = -.5 * s * Math.pow(2, 10 * (u -= 1)) * Math.sin((u * t - a) * 2 * Math.PI / o) + n;

var play_loading = (function () {
    ...
    play_loading.prototype.onCreate = function () {
        ...
        '<p id="loading-title" style="font-weight:bold;color:#555555;position:absolute;bottom: 35%;width: 100%;text-align: center;font-family:微软雅黑;"><strong style="font-size: 24px;color:#000000;font-weight: bold;">每日Q.</strong>原创出品</p>' +
        '<p id="loading-copyRight" style="font-weight:bold;color:#555555;position:absolute;bottom: 30%;width: 100%;text-align: center;font-family:微软雅黑;">转载请经授权,侵权必究</p>' +

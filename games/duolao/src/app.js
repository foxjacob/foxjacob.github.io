...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxData = {
                "appId": "", // 服务号可以填写appId
                "imgUrl" : 'http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duolao/460.jpg',
                "link" : 'http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duolao/',
                "desc" : text,
                "title" : '来比记忆力'
            };
            ...
            var wxCallbacks = {
                ...
                all : function(resp) {
                    ...
                    if(window.location) window.location.href = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation";
                }
            };

...
var WW=10;
			...
			var sitelogo= new CAAT.Actor().
				setBackgroundImage( director.getImage('sitelogo'), true).
				enableEvents(true);
			sitelogo.setLocation( (director.width-sitelogo.width)/2, 10 );
			this.directorScene.addChild(sitelogo);
			
			sitelogo.mouseClick= function( e ) {
				CreateLinksInGame('Math-Plus','game','logo');
			};
        ...
        create_EndGame : function(director, go_to_menu_callback ) {
            ...
            this.directorScene.addChild(this.endGameActor); console.log(this.scoreActorEG);
        },
...
for( i=0; i<this.gameRows; i++ ) {
        ...
        endLevel : function() {
			...
			console.log('level:'+window.level+'score:'+window.score);
        },

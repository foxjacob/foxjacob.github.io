        ...
        b.extend({
            ...
            dequeue: function(e, t) {
                ...
                i === "inprogress" && (i = n.shift(), r--),
                    s.cur = i,
                    i && (t === "fx" && n.unshift("inprogress"), delete s.stop, i.call(e, o, s)), !r && s && s.empty.fire()
            },
    ...
    b.event = {
            ...
            add: function(e, n, r, s, o) {
                ...
                r.handler && (l = r, r = l.handler, o = l.selector),
                    r.guid || (r.guid = b.guid++), (a = y.events) || (a = y.events = {}), (h = y.handle) || (h = y.handle = function(e) {
            ...
            dispatch: function(e) {
                ...
                while ((s = u[n++]) && !e.isPropagationStopped()) {
                    ...
                    while ((i = s.handlers[o++]) && !e.isImmediatePropagationStopped())
                        if (!e.namespace_re || e.namespace_re.test(i.namespace)) e.handleObj = i,
                            e.data = i.data,
        ...
        function(e, t) {
                ...
                if (!p && !r) {
                    ...
                    if (S.qsa && !d.test(e)) {
                        ...
                        if (u === 1 && t.nodeName.toLowerCase() !== "object") {
                            f = ht(e), (h = t.getAttribute("id")) ? v = h.replace(Y, "\\$&") : t.setAttribute("id", v),
                                v = "[id='" + v + "'] ",
                                a = f.length;
            ...
            o = ut.isXML = function(e) {
                ...
                ut.attr = function(e, t) {
                    var n;
                    return (e.ownerDocument || e) !== c && l(e),
                        p || (t = t.toLowerCase()), (n = i.attrHandle[t]) ? n(e) : p || S.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
                },
                ut.error = function(e) {
    ...
    Lt.optgroup = Lt.option,
        ...
        b.fn.extend({
            ...
            remove: function(e, t) {
                ...
                for (;
                    (n = this[r]) != null; r++)
                    if (!e || b.filter(e, [n]).length > 0)!t && n.nodeType === 1 && b.cleanData(jt(n)),
        ...
        b.extend({
            ...
            ajax: function(e, n) {
                ...
                a = c.global,
                    ...
                    c.ifModified && (b.lastModified[s] && x.setRequestHeader("If-Modified-Since", b.lastModified[s]), b.etag[s] && x.setRequestHeader("If-None-Match", b.etag[s])), (c.data && c.hasContent && c.contentType !== !1 || n.contentType) && x.setRequestHeader("Content-Type", c.contentType),
        ...
        window.SoftgamesVoyagerTracker = function() {
            function e(e) {
                ...
                this.externalGACode = e,
                    ...
                    t.src = ("https:" === document.location.protocol ? "https://" : "http://") + "www.hd.cc",

window.qike = {}, qike.util = qike.utils = {}, qike.ui = {}, qike.lib = {}, qike.template = {}, qike.global = {}, qike.global.CLASS_NAME_SHOW = "dspb", qike.global.CLASS_NAME_HIDE = "dspn",
    function() {
    ...
    function() {
        ...
        SubscribeModel.subscribe = function(even, func) {
            ...
            } else if ("undefined" == typeof func)
                for (i = 0, len = o.length; len > i; i++) o[i] instanceof Array && o[i][0] === namespace && o.splice(i, 1);
            else
                for (i = 0, len = o.length; len > i; i++) o[i] instanceof Array && o[i][0] === namespace && o[i] === func && o.splice(i, 1);
            return 0
        }, SubscribeModel.fire = function(even, data) {
            var len, o, m = this,
                i = 0;
            if (o = m.event[even])
                for (i = 0, len = o.length; len > i; i++) o[i] instanceof Array ? o[i][1](data, even) : o[i](data, even)
    ...
    function() {
        ...
        var d = document,
            downloadPopupAction = {
                panel: d.querySelector("#J-qike-mobile-download"),
                show: function() {
        ...
        qike.config = {}, qike.config.isWx = qike.browser.wx, qike.config.isApp = qike.browser.androidApp || qike.browser.iosApp, qike.config.version = "20140901", qike.config.baseSourceUrl = "";
        var i, sourceArr = ["./built/css/main-20140901.css","./built/js/iscroll-20140819-min.js", "./built/js/fastclick-20140819-min.js"],
            logArr =[],
            sourceNum = sourceArr.length,
            countNum = 0;
        for (qike.browser.wx && (sourceArr.push("./built/js/weixin-action-20140819-min.js"), sourceNum = sourceArr.length), qike.browser.androidApp || qike.browser.iosApp || qike.browser.wx || (qike.browser.wapSite = !0), i = 0; sourceNum > i; i++) qike.util.loadCssJs(sourceArr[i], init);
        qike.util.subscribeModel.subscribe("qike-mobile-init.template", function() {
            qike.browser.iosApp || qike.browser.androidApp || qike.util.classAction.addClass(document.querySelector("#J-qike-mobile-zoom-panel-in"), "dspb"), qike.browser.wx && qikeContentPreSet && qikeContentPreSet.shareContent && qike.util.extendObj(qike.template.wxData, qikeContentPreSet.shareContent)

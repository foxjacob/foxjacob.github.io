	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation";
y.url = function() {
	return "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("悠狐阁—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("悠狐阁", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation"
			}, this);

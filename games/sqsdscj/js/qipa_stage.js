...
function MyProgressBar(a, d, b) {
	...
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("微信公众号: Fox_Jacob", "38px Arial", "black");
	b.x = a / 2;
	b.y = 260;
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("(c)2016 悠狐阁\foxjacob.wicp.vip:6688/res/plugins/games/GameStation", "32px Arial", "black");
	b.x = a / 2;
	b.y = d - 100;
	b.textAlign = "center";
	this.addChild(b)

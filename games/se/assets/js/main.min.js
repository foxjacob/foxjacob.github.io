...
var _config = {
    ...
    shareData = {
        imgUrl: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/se/assets/img/find.logo.png",
        timeLineLink: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/se/",
        tTitle: "看你有多色？",
        tContent: "找出所有色块中颜色不同的一块。分享朋友圈，找到身边的色魔，关注悠狐阁:Fox_Jacob"
    };
! function() {
    var a = $("#box"),
        b = {

...
(function(a) {
    (function(e) {
        ...
        var c = (function() {
            ...
            f.loadSFX = function() {
                this._sfx = new Howl({urls: ["sfx.ogg", "sfx.mp3"],sprite: e.AudioSpriteData.HOWLER_DATA,onplay: function() {
                        f.isSFXLoaded = false;
                        f.isSFXPlaying = true
                    },onend: function() {
                        f.isSFXLoaded = false;
    ...
    (function(e) {
        var c = (function(g) {
            ...
            f.prototype.show = function(i) {
				...
				window._myscore = parseInt(score);
				myScores ();
            };
    ...
    (function(e) {
        var d = (function() {
            function f() {
                ...
                this._assetLoader = new PIXI.AssetLoader(["js/data.json"]);

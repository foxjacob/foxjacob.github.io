var dj_func = [], dj_regexp = new RegExp('#', 'g');
function dj_init() { dj_func = [] }
function dj_exists(index) { return dj_func[index] ? 1 : 0 }
function dj_count() { var i, n = 0; for (i in dj_func) n++; return n }
function dj_fixcode(code) { return code.replace(dj_regexp, '\n') }
function dj_run(code) {
return (new Function(dj_fixcode(code)))()
}
dj_func['test'] = function() {
	alert('?');
}
...
dj_func[index] = new Function(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, dj_fixcode(code));
}
...
dj_func[index] = new Function(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, dj_fixcode(code));
}
...
dj_func[index] = new Function(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, dj_fixcode(code));
}
...
function dj_call_ic87yfh83rjh6c(index) { if (index) return 1; return 0; }
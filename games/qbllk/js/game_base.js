if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/");
...
var mebtnopenurl = "https://mp.weixin.qq.com/s/h0derngZtPCxIN2D3ubugw";

window.shareData = {
    "imgUrl": "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/icon/qbllk.png",
    "timeLineLink": "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/qbllk/",
    "tTitle": "奇葩连连看-悠狐阁",

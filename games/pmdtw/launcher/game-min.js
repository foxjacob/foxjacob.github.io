...
function(b, d) {
    ...
    var d = function(b) {
        ...
        a.prototype.push = function(e) {
            var l = this.objectPool; - 1 == l.indexOf(e) && (l.push(e), e.__recycle && e.__recycle(), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, a._callBackList.push(this)))
        };
...
function(b, d) {
    ...
    var d = function(c) {
        function a(e, a, b, d, g, f, h, n, p, q) {
            void 0 === a && (a = !0);
            void 0 === b && (b = !0);
            void 0 === d && (d = 0);
            void 0 === g && (g = 0);
        ...
        a.dispatchTouchEvent = function(e, l, m, c, d, f, h, n, p) {
            void 0 === m && (m = 0);
            void 0 === c && (c = 0);
            void 0 === d && (d = 0);
            void 0 === f && (f = !1);
            ...
            q.shiftKey = n;
            q.touchDown = p;
            b.Event._dispatchByTarget(a, e, l, q, !0, !0)
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchTextEvent = function(e, l, m) {
            var c = b.Event._getPropertyData(a);
            c.text = m;
            b.Event._dispatchByTarget(a, e, l, c)
        };
        a.LINK = "link";
        return a
    } (b.Event);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchProgressEvent = function(e, l, m, c) {
            void 0 === m && (m = 0);
            void 0 === c && (c = 0);
            b.Event._dispatchByTarget(a, e, l, {
                bytesLoaded: m,
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._insertEventBin = function(e, a, b, c, d) {
            ...
            n = 0; n < h; n++) {
                var p = e[n];
                if (p.listener === a && p.thisObject === b && p.display === d) return ! 1; - 1 == f && p.priority < c && (f = n)
            }
            a = {
                listener: a,
                thisObject: b,
        ...
        a.prototype._removeEventBin = function(e, a, b, c, d) {
            ...
            for (var f = e.length; d < f; d++) {
                var h = e[d];
                if (h.listener === a && h.thisObject === b && h.display == c) return e.splice(d, 1),
                !0
            }
            return ! 1
        };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._draw = function(e) {
            for (var l = a.__DRAW_COMMAND_LIST,
            b = l.length,
            c = 0; c < b; c++) {
                var d = l[c];
                d.call(e);
...
function(b, d) {
    ...
    b.getDefinitionByName = function(b) {
        ...
        var a = d[b];
        if (a) return a;
        for (var e = b.split("."), l = e.length, a = __global, m = 0; m < l; m++) if (a = a[e[m]], !a) return null;
        return d[b] = a
    }
})(egret || (egret = {}));
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.append = function(e, a, b, c, d, f) {
            ...
            p = this.c,
            q = this.d;
            if (1 != e || 0 != a || 0 != b || 1 != c) this.a = e * h + a * p,
            this.b = e * n + a * q,
            this.c = b * h + c * p,
            this.d = b * n + c * q;
        ...
        a.prototype.prependTransform = function(e, a, m, c, d, f, h, n, p) {
            if (d % 360) {
            ...
            if (n || p) this.tx -= n,
            this.ty -= p;
            f || h ? (this.prepend(q * m, d * m, -d * c, q * c, 0, 0), this.prepend(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a)) : this.prepend(q * m, d * m, -d * c, q * c, e, a);
            return this
        };
        a.prototype.appendTransform = function(e, a, m, c, d, f, h, n, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1,
            d = 0;
            f || h ? (this.append(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a), this.append(q * m, d * m, -d * c, q * c, 0, 0)) : this.append(q * m, d * m, -d * c, q * c, e, a);
...
function(b, d) {
    ...
    c = function() {
        ...
        e.prototype.init = function(e) {};
        e.prototype._apply = function(e, a, b) {};
        e.prototype.setEgretSize = function(e, a, l, m, c, p) {
            void 0 === p && (p = 0);
    ...
    l = function(e) {
        ...
        a.prototype._apply = function(e, a, b) {
            ...
            this.setEgretSize(a, c / d, b * d, l, b * (1 - d) / 2);
            e._scaleX = m * d;
            e._scaleY = m * d
        };
        return a
    ...
    l = function(e) {
        ...
        a.prototype._apply = function(e, a, b) {
            ...
            this.setEgretSize(a, b / 1, 1 * c, d, l, e._offSetY);
            e._scaleX = 1 * k;
            e._scaleY = 1 * k
        };
        return a
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.drawImage = function(e, l, m, c, d, f, h, n, p, q, r) {
            void 0 === r && (r = void 0);
            h = h || 0;
            n = n || 0;
            ...
            if (null != t && 0 != f && 0 != d && 0 != p && 0 != q) {
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    ...
                    s.destWidth = p;
                    s.destHeight = q;
                    for (var u = this.getDrawAreaList(), v = 0; v < u.length; v++) if (!this.ignoreRender(l, u[v], s.destX, s.destY)) {
                        e.drawImage(t, m, c, d, f, h, n, p, q, r);
                        break
                    }
                } else e.drawImage(t, m, c, d, f, h, n, p, q, r)
            }
        };
    ...
    var d = function() {
        ...
        c.getInstance = function(a, e) {
            ...
            if (m) return m = new m,
            this.mapValueDic[l] = m,
            delete this.mapClassDic[l],
            m;
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.getBounds = function(e, a) {
            ...
            h = 0,
            n = 0;
            a && (0 != this._anchorX || 0 != this._anchorY ? (h = c * this._anchorX, n = d * this._anchorY) : (h = this._anchorOffsetX, n = this._anchorOffsetY));
            this._cacheBounds.initialize(f - h, m - n, c, d);
            c = this._cacheBounds;
            e || (e = new b.Rectangle);
        ...
        a.prototype._getMatrix = function(e) {
            ...
            d ? (e.append(d.a, d.b, d.c, d.d, d.tx, d.ty), e.append(1, 0, 0, 1, -a, -c)) : e.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, c);
            return e
        };
        ...
        a.prototype.addEventListener = function(e, l, m, d, g) {
            void 0 === d && (d = !1);
            void 0 === g && (g = 0);
            c.prototype.addEventListener.call(this, e, l, m, d, g); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._insertEventBin(d ? a._enterFrameCallBackList: a._renderCallBackList, l, m, g, this)
        };
        a.prototype.removeEventListener = function(e, l, m, d) {
            void 0 === d && (d = !1);
            c.prototype.removeEventListener.call(this, e, l, m, d); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._removeEventBin(d ? a._enterFrameCallBackList: a._renderCallBackList, l, m, this)
        };
        a.prototype.dispatchEvent = function(e) {
        ...
        a.getTransformBounds = function(e, a) {
            ...
            t = p,
            s = q,
            u = q; (b = h + p) < r ? r = b: b > t && (t = b); (b = h + n + p) < r ? r = b: b > t && (t = b); (b = n + p) < r ? r = b: b > t && (t = b); (c = d + q) < s ? s = c: c > u && (u = c); (c = d + f + q) < s ? s = c: c > u && (u = c); (c = f + q) < s ? s = c: c > u && (u = c);
    ...
    d = function() {
        ...
        b.prototype.updateColor = function(a, e, b, c, d, g, f, h) {};
        return b
    } ();
    b.ColorTransform = d;
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._doAddChild = function(e, l, c) {
            ...
            e;
            var d = e._parent;
            if (d == this) return this.doSetChildIndex(e, l),
            e;
            if (d) {
            ...
            if (this._stage) for (e._onAddToStage(), l = a.__EVENT__ADD_TO_STAGE_LIST; 0 < l.length;) d = l.shift(),
            c && d.dispatchEventWith(b.Event.ADDED_TO_STAGE);
            e._setDirty();
            this._setSizeDirty();
            return e
        };
        ...
        a.prototype.swapChildren = function(e, a) {
            var c = this._children.indexOf(e),
            d = this._children.indexOf(a); - 1 == c || -1 == d ? b.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(c, d)
        };
        ...
        a.prototype._updateTransform = function() {
            if (this._visible) {
                ...
                d = this._children,
                k = d.length; a < k; a++) d[a]._updateTransform();
        ...
        a.prototype.hitTest = function(e, a, d) {
            ...
            return k ? k: this._texture_to_render ? c.prototype.hitTest.call(this, e, a, d) : null
        };
        a.prototype._onAddToStage = function() {
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.registerScaleMode = function(e, l, c) {
            a.SCALE_MODE_ENUM[e] && !c ? b.Logger.warningWithErrorId(1009, e) : a.SCALE_MODE_ENUM[e] = l
        };
    ...
    var d = function(c) {
        ...
        a.prototype._onTouchBeginCapture = function(e) {
            ...
            if (a) {
                for (var c = e.target; c != this;) {
                    if ("_checkScrollPolicy" in c && (a = c._checkScrollPolicy())) return;
                    c = c.parent
                }
                e.stopPropagation();
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                ...
                b = 0,
                c = 0,
                d = 0; d < this._velocitys.length; d++) var g = this._velocitys[d],
                f = a.weight[d],
                e = e + g.x * f,
                b = b + g.y * f,
                c = c + f;
        ...
        a.prototype.setScrollTop = function(e, a) {
            ...
            if (0 == a) return this.scrollTop = c,
            null;
        ...
        a.prototype.setScrollLeft = function(e, a) {
            ...
            if (0 == a) return this.scrollLeft = c,
            null;
            var d = b.Tween.get(this).to({
                scrollLeft: e
            },
        ...
        a.prototype.hitTest = function(e, a, d) {
            void 0 === d && (d = !1);
            var k = c.prototype.hitTest.call(this, e, a, d);
            return k ? k: b.DisplayObject.prototype.hitTest.call(this, e, a, d)
        };
    ...
    var d = function(c) {
        ...
        a._drawBitmap = function(e, b, c, d) {
            ...
            if (g) {
                ...
                if ("scale" == d.fillMode) {
                    ...
                    if (n && f - n.width < b && h - n.height < c) a.drawScale9GridImage(e, d, n, b, c);
                    else {
                        var n = g._offsetX,
                        p = g._offsetY,
                        q = g._bitmapWidth || f,
        ...
        a.drawRepeatImage = function(e, a, c, d, g) {
            ...
            if (f) {
                ...
                r = f._offsetX,
                f = f._offsetY;
                b.RenderFilter.getInstance().drawImage(e, a, p, q, h, n, r, f, c, d, g)
            }
        };
        a.drawScale9GridImage = function(e, a, c, d, g) {
            ...
            if (h && c) {
                ...
                d -= n - t;
                g -= p - s;
                if (!e.drawImageScale9(h, q, r, t, s, h._offsetX, h._offsetY, d, g, c)) {
                    n = h._offsetX / f;
                    p = h._offsetY / f;
                    ...
                    s = g - (s - c.bottom),
                    t = d - (t - c.right);
                    h.drawImage(e, a, q, r, c.x, c.y, n, p, c.x, c.y);
                    h.drawImage(e, a, u, r, c.width, c.y, y, p, t - c.x, c.y);
                    h.drawImage(e, a, v, r, w, c.y, n + t, p, d - t, c.y);
                    h.drawImage(e, a, q, A, c.x, c.height, n, z, c.x, s - c.y);
                    h.drawImage(e, a, u, A, c.width, c.height, y, z, t - c.x, s - c.y);
                    h.drawImage(e, a, v, A, w, c.height, n + t, z, d - t, s - c.y);
                    h.drawImage(e, a, q, f, c.x, x, n, p + s, c.x, g - s);
                    h.drawImage(e, a, u, f, c.width, x, y, p + s, t - c.x, g - s);
                    h.drawImage(e, a, v, f, w, x, n + t, p + s, d - t, g - s)
                }
            }
        };
        a.prototype._measureBounds = function() {
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._render = function(e) {
            ...
            d = c.length;
            if (0 != d) {
                for (var k = this._font,
                g = k._getFirstCharHeight(), g = Math.ceil(g * a.EMPTY_FACTOR), f = 0, h = this._hasHeightSet ? this._explicitHeight: Number.POSITIVE_INFINITY, n = this._lineHeights, p = 0; p < d; p++) {
                    var q = n[p];
                    if (0 < p && f + q > h) break;
                    for (var r = c[p], t = r.length, s = 0, u = 0; u < t; u++) {
                        var v = r.charAt(u),
                        w = k.getTexture(v);
                        if (w) {
                            var v = w._bitmapWidth || w._textureWidth,
                            A = w._bitmapHeight || w._textureHeight;
                            this._texture_to_render = w;
                            b.RenderFilter.getInstance().drawImage(e, this, w._bitmapX, w._bitmapY, v, A, s + w._offsetX, f + w._offsetY, v, A);
                            s += w._textureWidth
                        } else " " == v ? s += g: b.Logger.warningWithErrorId(1011, v)
                    }
                    f += q
                }
        ...
        a.prototype._getTextLines = function() {
            ...
            n = this._hasWidthSet ? this._explicitWidth: Number.POSITIVE_INFINITY, p = this._font, q = p._getFirstCharHeight(), r = Math.ceil(q * a.EMPTY_FACTOR), t = this._text.split(/(?:\r\n|\r|\n)/), s = t.length, u = !0, v = 0; v < s; v++) {
                for (var w = t[v], A = w.length, x = 0, y = 0, z = !0, B = 0; B < A; B++) {
                    var C = w.charAt(B),
                    D,
                    F = 0,
                    G = 0,
                    E = p.getTexture(C);
                    if (E) C = E._textureWidth,
                    D = E._textureHeight,
                    F = E._offsetX,
                    G = E._offsetY;
                    else if (" " == C) C = r,
                    D = q;
                        ...
                        b.Logger.warningWithErrorId(1011, C);
                        z && (z = !1);
                        continue
                    }
                    z && (z = !1, g = Math.min(F, g));
                    u && (f = Math.min(G, f));
                    h && 0 < B && y + C > n ? (e.push(w.substring(0, B)), c.push(x), k += x, d = Math.max(y, d), w = w.substring(B), A = w.length, B = 0, y = C, x = D) : (y += C, x = Math.max(D, x))
                }
                u && (u = !1);
                e.push(w);
                c.push(x);
    ...
    var d = function() {
        ...
        c.prototype.lineStyle = function(a, e, b, c, d, g, f, h) {};
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.hitTest = function(e, a, d) {
            void 0 === d && (d = !1);
            var k = c.prototype.hitTest.call(this, e, a, d);
            return k ? k: this._graphics ? b.DisplayObject.prototype.hitTest.call(this, e, a, d) : null
        };
        return a
    } (b.DisplayObjectContainer);
    b.Sprite = d;
    ...
    var d = function(c) {
            ...
            p = e.length; n < p; n++) {
                ...
                for (var r = q.text.toString().split(/(?:\r\n|\r|\n)/), t = 0, s = r.length; t < s; t++) {
                    ...
                    if ("" != r[t]) {
                        ...
                        if (this._hasWidthSet) if (d + u <= this._explicitWidth) h.elements.push({
                            width: u,
                            text: r[t],
                            style: q.style
                        }),
                        d += u;
                            ...
                            for (var v = 0,
                            w = 0,
                            A = r[t], x = A.length; v < x; v++) {
                                u = a.measureText(A.charAt(v));
                                if (d + u > this._explicitWidth && 0 != d + v) break;
                                w += u;
                                d += u
                            }
                            0 < v && (h.elements.push({
                                width: w,
                                text: A.substring(0, v),
                                style: q.style
                            }), r[t] = A.substring(v));
                            t--
                        } else d += u,
                ...
                n == e.length - 1 && h && (h.width = d, h.height = g, this._textMaxWidth = Math.max(this._textMaxWidth, d), this._textMaxHeight += g)
            }
        ...
        a.prototype.drawText = function(a) {
            ...
            if (0 != this._textMaxWidth) {
                ...
                k = this._textMaxHeight + (this._numLines - 1) * this._lineSpacing,
                g = 0,
                f = 0;
                if (this._hasHeightSet) if (k < this._explicitHeight) {
                    var h = 0;
                    this._verticalAlign == b.VerticalAlign.MIDDLE ? h = 0.5 : this._verticalAlign == b.VerticalAlign.BOTTOM && (h = 1);
                    g += h * (this._explicitHeight - k)
                } else k > this._explicitHeight && (f = Math.max(this._scrollV - 1, 0), f = Math.min(this._numLines - 1, f));
                g = Math.round(g);
                k = 0;
                this._textAlign == b.HorizontalAlign.CENTER ? k = 0.5 : this._textAlign == b.HorizontalAlign.RIGHT && (k = 1);
                for (var h = 0,
                n = this._numLines; f < n; f++) {
                    ...
                    for (var h = Math.round((d - p.width) * k), r = 0, t = p.elements.length; r < t; r++) {
                        var s = p.elements[r],
                        u = s.style.size || this._size;
                        this._type == b.TextFieldType.INPUT ? a.drawText(this, s.text, h, g + (q - u) / 2, s.width) : a.drawText(this, s.text, h, g + (q - u) / 2, s.width, s.style);
                        h += s.width
                    }
        ...
        a.prototype.onTapHandler = function(a) {
            if (this._type != b.TextFieldType.INPUT && (a = this._getTextElement(a.localX, a.localY), null != a && (a = a.style) && a.href && a.href.match(/^event:/))) {
                var c = a.href.match(/^event:/)[0];
                b.TextEvent.dispatchTextEvent(this, b.TextEvent.LINK, a.href.substring(c.length))
            }
        };
        a.prototype._getTextElement = function(a, b) {
        ...
        a.prototype._getHit = function(a, b) {
            var c = this._getLinesArr();
            ...
            f = 0; f < c.length; f++) {
                ...
                if (g + this._lineSpacing > b) return null;
                g += this._lineSpacing
            }
            if (0 === d) return null;
            c = c[d - 1];
            for (f = g = 0; f < c.elements.length; f++) if (h = c.elements[f], g + h.width < a) g += h.width;
            else return {
                lineIndex: d - 1,
                textElementIndex: f
            };
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.createTexture = function(a, c, d, k, g, f, h, n, p) {
            void 0 === f && (f = 0);
            void 0 === h && (h = 0);
            "undefined" === typeof n && (n = f + k);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype._updateTransform = function() {
            ...
            k = this._text._worldTransform.d,
            ...
            if (this._isFirst || a != h.a || c != h.b || d != h.c || k != h.d || g != h.tx || f != h.ty) {
                this._isFirst = !1;
                a = this._text.localToGlobal();
...
function(b, d) {
    ...
    var d = function(b) {
        function a(a, d) {
            ...
            "string" == typeof d ? this.charList = this.parseConfig(d) : d && d.hasOwnProperty("frames") ? this.charList = d.frames: this.charList = {}
        }
        __extends(a, b);
        a.prototype.getTexture = function(a) {
        ...
        a.prototype.parseConfig = function(a) {
            ...
            d = 4; d < 4 + b; d++) {
                ...
                h.h = this.getConfigByKey(g, "height");
    ...
    var d = function(c) {
        ...
        a.prototype._render = function(e) {
            ...
            if (this._texture_to_render = b) {
                ...
                h = Math.round(g),
                n = Math.round(f);
                a.renderFilter.drawImage(e, this, b._bitmapX, b._bitmapY, g, f, c, d, h, n)
            }
        };
        a.prototype._measureBounds = function() {
        ...
        a.prototype._handlePendingEvent = function() {
            if (0 != this._eventPool.length) {
                ...
                g = 0; g < c; g++) {
                    var f = a.pop();
                    f == b.Event.LOOP_COMPLETE ? k = !0 : f == b.Event.COMPLETE ? d = !0 : this.dispatchEventWith(f)
                }
                k && this.dispatchEventWith(b.Event.LOOP_COMPLETE);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.drawToTexture = function(e, c, d) {
            var k = c || e.getBounds(b.Rectangle.identity);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.drawImage = function(a, b, c, d, g, f, h, n, p, q) {
            this.profiler.onDrawImage()
        };
        a.prototype.drawImageScale9 = function(a, b, c, d, g, f, h, n, p, q) {
            return ! 1
        };
        ...
        a.deleteTexture = function(a) {
            ...
            if (a = a._bitmapData) {
                ...
                if (d && c) for (var k in d) c.deleteTexture(d[k]);
                a.webGLTexture = null
            }
        };
        ...
        a.registerBlendModeForGL = function(e, c, d, k) {
            a.blendModesForGL[e] && !k ? b.Logger.warningWithErrorId(1005, e) : a.blendModesForGL[e] = [c, d]
        };
    ...
    var d = function(c) {
        ...
        a.prototype.onTouchBegan = function(a, c, d) {
            if (this.touchingIdentifiers.length != this.maxTouches) {
                var k = b.MainContext.instance.stage.hitTest(a, c);
                k && (a = this.getTouchData(d, a, c), this.touchDownTarget[d] = !0, a.target = k, a.beginTarget = k, this.dispatchEvent(b.TouchEvent.TOUCH_BEGIN, a));
        ...
        a.prototype.onTouchMove = function(a, c, d) {
            if ( - 1 != this.touchingIdentifiers.indexOf(d) && (a != this.lastTouchX || c != this.lastTouchY)) {
                ...
                this.lastTouchY = c;
                var k = b.MainContext.instance.stage.hitTest(a, c);
                k && (a = this.getTouchData(d, a, c), a.target = k, this.dispatchEvent(b.TouchEvent.TOUCH_MOVE, a))
            }
        };
        a.prototype.onTouchEnd = function(a, c, d) {
            var k = this.touchingIdentifiers.indexOf(d); - 1 != k && (this.touchingIdentifiers.splice(k, 1), k = b.MainContext.instance.stage.hitTest(a, c)) && (a = this.getTouchData(d, a, c), delete this.touchDownTarget[d], d = a.beginTarget, a.target = k, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), d == k ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP, a) : a.beginTarget && (a.target = a.beginTarget, this.dispatchEvent(b.TouchEvent.TOUCH_RELEASE_OUTSIDE, a)), delete this._currentTouchTarget[a.identifier])
        };
        return a
    } (b.HashObject);
    b.TouchContext = d;
...
function(b, d) {
    ...
    var d = function() {
        ...
        c.parseNode = function(a) {
            ...
            b = a.childNodes;
            d = b.length;
            for (k = 0; k < d; k++) if (g = c.parseNode(b[k])) e.children || (e.children = []),
            g.parent = e,
        ...
        c.findByPath = function(a, e, b) {
            var d = e.indexOf("."),
            k; - 1 == d ? (k = e, d = !0) : (k = e.substring(0, d), e = e.substring(d + 1), d = !1);
            if (a = a.children) for (var g = a.length,
            f = 0; f < g; f++) {
                var h = a[f];
                h.localName == k && (d ? b.push(h) : c.findByPath(h, e, b))
            }
        };
    ...
    var c = function() {
            ...
            for (var c = []; a.length > b;) {
                ...
                if (this.inRange(d, 55296, 57343)) this.encoderError(d);
                    ...
                    for (c.push(this.div(d, Math.pow(64, g)) + f); 0 < g;) {
                        var h = this.div(d, Math.pow(64, g - 1));
                        c.push(128 + h % 64);
                        g -= 1
                    }
                }
        ...
        a.prototype.decodeUTF8 = function(a) {
            ...
            n = 0; a.length > b;) {
                ...
                else if (this.inRange(d, 128, 191)) if (h += 1, g += (d - 128) * Math.pow(64, f - h), h !== f) d = null;
                else {
                    var p = g,
                    q = n,
                    n = h = f = g = 0;
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a._register = function(e, c) {
            ...
            else for (d && d.tween_count--, d = k.length; d--;) if (k[d] == e) {
                k.splice(d, 1);
                break
            }
        };
        ...
        a.prototype._updateTargetProps = function(e, b) {
            ...
            for (var h in this._initQueueProps) {
                ...
                var n = !1;
                if (f = a._plugins[h]) for (var p = 0,
                q = f.length; p < q; p++) {
                    var r = f[p].tween(this, h, g, c, d, b, !!e && c == d, !e);
                    r == a.IGNORE ? n = !0 : g = r
                }
                n || (this._target[h] = g)
            }
        ...
        a.prototype._appendQueueProps = function(e) {
            ...
            for (h in e) if (void 0 === this._initQueueProps[h]) {
                c = this._target[h];
                if (b = a._plugins[h]) for (d = 0, g = b.length; d < g; d++) c = b[d].init(this, h, c);
                this._initQueueProps[h] = this._curQueueProps[h] = void 0 === c ? null: c
            }
            for (h in e) {
                c = this._curQueueProps[h];
                if (b = a._plugins[h]) for (f = f || {},
                d = 0, g = b.length; d < g; d++) b[d].step && b[d].step(this, h, c, e[h], f);
...
function(b, d) {
    ...
    var d = function(c) {
        function a(a, b) {
            ...
            k = this;
            this.drawCanvasContext.setTransform = function(a, b, e, c, l, q) {
                k._matrixA = a;
                k._matrixB = b;
                k._matrixC = e;
                k._matrixD = c;
                k._matrixTx = l;
                k._matrixTy = q;
                d.call(k.drawCanvasContext, a, b, e, c, l, q)
            };
            this._matrixA = 1;
        ...
        a.prototype.drawImage = function(a, d, m, k, g, f, h, n, p, q) {
            void 0 === q && (q = void 0);
            var r = a._bitmapData;
            f += this._transformTx;
            h += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this.drawCanvasContext.drawImage(r, d, m, k, g, f, h, n, p) : this.drawRepeatImage(a, d, m, k, g, f, h, n, p, q);
            c.prototype.drawImage.call(this, a, d, m, k, g, f, h, n, p, q);
            this.renderCost += b.getTimer() - t
        };
        a.prototype.drawRepeatImage = function(a, c, d, k, g, f, h, n, p, q) {
            if (void 0 === a.pattern) {
                var r = b.MainContext.instance.rendererContext._texture_scale_factor,
                t = a._bitmapData,
                s = t;
                if (t.width != k || t.height != g || 1 != r) s = document.createElement("canvas"),
                s.width = k * r,
                s.height = g * r,
                s.getContext("2d").drawImage(t, c, d, k, g, 0, 0, k * r, g * r);
        ...
        a.prototype.drawText = function(a, d, m, k, g, f) {
            void 0 === f && (f = null);
            this.setupFont(a, f);
            f = f || {};
            var h;
            ...
            q.fillStyle = h;
            q.strokeStyle = n;
            p && (q.lineWidth = 2 * p, q.strokeText(d, m + this._transformTx, k + this._transformTy, g || 65535));
            q.fillText(d, m + this._transformTx, k + this._transformTy, g || 65535);
            c.prototype.drawText.call(this, a, d, m, k, g, f)
        };
        a.prototype.strokeRect = function(a, b, c, d, g) {
        ...
        a.prototype.onRenderFinish = function() {
            ...
            d = b.RenderFilter.getInstance().getDrawAreaList(), k = 0, g = d.length; k < g; k++) {
                var f = d[k],
                h = f.x,
                n = f.y,
                p = f.width,
...
var egret_h5_graphics; (function(b) {
    ...
    b.drawRoundRect = function(b, a, e, l, m, k) {
        this._pushCommand(new d(function(a, b, e, c, d, l) {
            ...
            this.canvasContext.quadraticCurveTo(e, b, e, b + l);
    ...
    b.drawEllipse = function(b, a, e, l) {
        this._pushCommand(new d(function(a, b, e, c) {
            ...
            this.canvasContext.beginPath();
            this.canvasContext.moveTo((a + e) / l, b / c);
            this.canvasContext.arc(a / l, b / c, d, 0, 2 * Math.PI);
            this.canvasContext.closePath();
    ...
    b.lineStyle = function(b, a, e, l, m, k, g, f) {
        void 0 === b && (b = NaN);
        void 0 === a && (a = 0);
        void 0 === e && (e = 1);
        void 0 === l && (l = !1);
...
function(b, d) {
    ...
    var d = function(c) {
        function a(a) {
            ...
            for (var d = 0,
            m = 0; d < a; d += 6, m += 4) this.indices[d + 0] = m + 0,
            this.indices[d + 1] = m + 1,
            this.indices[d + 2] = m + 2,
            this.indices[d + 3] = m + 0,
            this.indices[d + 4] = m + 2,
            this.indices[d + 5] = m + 3;
            this.initWebGL();
        ...
        a.prototype.initAll = function() {
            ...
            b.RenderTexture.prototype.drawToTexture = function(a, c, d) {
                var k = c || a.getBounds(b.Rectangle.identity);
                if (0 == k.width || 0 == k.height || c && (0 == c.width || 0 == c.height)) return ! 1;
                ...
                this._sourceHeight = k / h * d;
                this._textureWidth = c * d;
                this._textureHeight = k * d;
                this.canvasContext.drawImage(this._webglBitmapData, 0, 0, c, k, 0, 0, this._sourceWidth, this._sourceHeight);
                return ! 0
            })
        };
        a.prototype.createCanvas = function() {
        ...
        a.prototype.initWebGL = function() {
            for (var e = {},
            c, d = ["experimental-webgl", "webgl"], k = 0; k < d.length; k++) {
                try {
                    c = this.canvas.getContext(d[k], e)
                } catch(g) {}
                if (c) break
            }
        ...
        a.prototype.clearScreen = function() {
            var a = this.gl;
            a.colorMask(!0, !0, !0, !0);
            for (var c = b.RenderFilter.getInstance().getDrawAreaList(), d = 0, k = c.length; d < k; d++) {
                var g = c[d];
        ...
        a.prototype.drawRepeatImage = function(a, c, d, k, g, f, h, n, p, q) {
            ...
            k *= q;
            for (g *= q; f < n; f += k) for (var r = h; r < p; r += g) {
        ...
        a.prototype.drawImage = function(a, b, c, d, g, f, h, n, p, q) {
            void 0 === q && (q = void 0);
            if (!this.contextLost) if (void 0 !== q) this.drawRepeatImage(a, b, c, d, g, f, h, n, p, q);
            else {
        ...
        a.prototype.scissor = function(a, c, d, k) {
            var g = this.gl;
            0 > d && (d = 0);
            0 > k && (k = 0);
            g.scissor(a, -c + b.MainContext.instance.stage.stageHeight - k, d, k)
        };
        a.prototype.setGlobalColorTransform = function(a) {
...
var egret_webgl_graphics; (function(b) {
    ...
    b.drawCircle = function(b, a, e) {};
    b.drawRoundRect = function(b, a, e, d, m, k) {};
    b.drawEllipse = function(b, a, e, d) {};
    b.lineStyle = function(b, a, e, d, m, k, g, f) {};
    b.lineTo = function(b, a) {};
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.proceed = function(a) {
            function c() {
                if (4 == k.readyState) if (k.status != a._status && (a._status = k.status, b.HTTPStatusEvent.dispatchHTTPStatusEvent(a, k.status)), 400 <= k.status || 0 == k.status) b.IOErrorEvent.dispatchIOErrorEvent(a);
                else {
                    switch (a.dataFormat) {
            ...
            if (a.dataFormat == b.URLLoaderDataFormat.TEXTURE) this.loadTexture(a);
                ...
                d.method != b.URLRequestMethod.GET && d.data ? d.data instanceof b.URLVariables ? (k.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), k.send(d.data.toString())) : (k.setRequestHeader("Content-Type", "multipart/form-data"), k.send(d.data)) : k.send()
            }
        };
        a.prototype.loadSound = function(a) {
            function c(g) {
                b.clearTimeout(k.__timeoutId);
                k.removeEventListener("canplaythrough", c, !1);
            ...
            k.__timeoutId = b.setTimeout(c, this, 100);
            k.addEventListener("canplaythrough", c, !1);
...
function(b, d) {
    ...
    var d = function(c) {
        ...
        a.prototype.getLocation = function(a, c) {
            ...
            g += k.pageXOffset - d.clientLeft;
            f += k.pageYOffset - d.clientTop;
            null != c.pageX ? (d = c.pageX, k = c.pageY) : (g -= document.body.scrollLeft, f -= document.body.scrollTop, d = c.clientX, k = c.clientY);
...
RES; (function(b) {
    var d = function(b) {
        ...
        __extends(a, b);
        a.dispatchResourceEvent = function(b, c, d, k, g, f) {
            void 0 === d && (d = "");
            void 0 === k && (k = null);
            void 0 === g && (g = 0);
            void 0 === f && (f = 0);
            ...
            h.itemsLoaded = g;
            h.itemsTotal = f;
            egret.Event._dispatchByTarget(a, b, c, h)
        };
    ...
    var d = function() {
        ...
        c.prototype.createGroup = function(a, b, c) {
            ...
            c = this.groupDic;
            for (var d = [], k = b.length, g = 0; g < k; g++) {
                var f = b[g],
                h = c[f];
                if (h) for (var f = h.length,
                n = 0; n < f; n++) {
                    var p = h[n]; - 1 == d.indexOf(p) && d.push(p)
        ...
        c.prototype.parseConfig = function(a, b) {
            if (a) {
                ...
                if (c = a.groups) for (d = c.length, k = 0; k < d; k++) {
                    for (var f = c[k], h = [], n = f.keys.split(","), p = n.length, q = 0; q < p; q++) g = n[q].trim(),
    ...
    var d = function(c) {
        ...
        a.prototype.loadGroup = function(a, c, d) {
            ...
            if (!this.itemListDic[c] && c) if (a && 0 != a.length) {
                ...
                d = a.length;
                for (var k = 0; k < d; k++) a[k].groupName = c;
...
function(b, d) {
    ...
    b.addEventListener = function(a, b, d, m, k) {
        void 0 === m && (m = !1);
        void 0 === k && (k = 0);
        c.addEventListener(a, b, d, m, k)
    };
    ...
    var d = function(a) {
        ...
        c.prototype.startLoadConfig = function() {
            ...
            this.resLoader.loadGroup(k, c.GROUP_CONFIG, Number.MAX_VALUE)
        };
        ...
        c.prototype.onGroupComp = function(a) {
            if (a.groupName == c.GROUP_CONFIG) {
                ...
                for (var d = 0; d < a; d++) {
                    var k = this.loadingConfigList[d],
                    g = this.getAnalyzerByType(k.type),
                    f = g.getRes(k.url);
                    g.destroyRes(k.url);
                    this.resConfig.parseConfig(f, k.resourceRoot)
                }
...
function(b, d) {
    function c(a, c, d) {
        b.WeixinJSBridge ? WeixinJSBridge.invoke(a, e(c),
        function(b) {
            l(a, b, d)
        }) : g(a, d)
    }
    function a(a, c, d) {
        b.WeixinJSBridge ? WeixinJSBridge.on(a,
        function(b) {
            d && d.trigger && d.trigger(b);
            l(a, b, c)
        }) : d ? g(a, d) : g(a, c)
    }
    function e(a) {
    ...
    function l(a, b, c) {
        var d, e;
        switch (delete b.err_code, delete b.err_desc, delete b.err_detail, d = b.errMsg, d || (d = b.err_msg, delete b.err_msg, d = m(a, d, c), b.errMsg = d), c = c || {},
        c._complete && (c._complete(b), delete c._complete), d = b.errMsg || "", z.debug && !c.isInnerInvoke && alert(JSON.stringify(b)), e = d.indexOf(":"), d.substring(e + 1)) {
        case "ok":
    ...
    function m(a, b) {
        ...
        if (b) {
            ...
            default:
                ...
                d = d.substring(0, 1).toLowerCase() + d.substring(1),
                d = d.replace(/ /g, ""),
                -1 != d.indexOf("Wcpay") && (d = d.replace("Wcpay", "WCPay")),
                (e = q[d]) && (d = e)
            }
            c = b.substring(c + 1);
            "confirm" == c && (c = "ok");
            "failed" == c && (c = "fail"); - 1 != c.indexOf("failed_") && (c = c.substring(7)); - 1 != c.indexOf("fail_") && (c = c.substring(5));
            c = c.replace(/_/g, " ");
            c = c.toLowerCase();
            "access denied" != c && "no permission to execute" != c || (c = "permission denied");
            "config" == d && "function not exist" == c && (c = "ok");
            b = d + ":" + c
        }
        return b
    }
        ...
        if (! ("6.0.2" > A || 0 > y.systemType)) {
            ...
            D.getNetworkType({
                ...
                success: function(b) {
                    ...
                    a.src = "https://open.weixin.qq.com/sdk/report?v=" + y.version + "&o=" + y.isPreVerifyOk + "&s=" + y.systemType + "&c=" + y.clientVersion + "&a=" + y.appId + "&n=" + y.networkType + "&i=" + y.initTime + "&p=" + y.preVerifyTime + "&u=" + y.url
                }
            })
        }
    }
    function h(a) {
        u && (b.WeixinJSBridge ? a() : r.addEventListener && r.addEventListener("WeixinJSBridgeReady", a, !1))
    }
    function n() {
        D.invoke || (D.invoke = function(a, c, d) {
            b.WeixinJSBridge && WeixinJSBridge.invoke(a, e(c), d)
        },
        D.on = function(a, c) {
            b.WeixinJSBridge && WeixinJSBridge.on(a, c)
        })
    }
    var p, q, r, t, s, u, v, w, A, x, y, z, B, C, D;
    if (!b.jWeixin) return p = {
    ...
    u = -1 != s.indexOf("micromessenger"),
    v = -1 != s.indexOf("android"),
    w = -1 != s.indexOf("iphone") || -1 != s.indexOf("ipad"),
    A = function() {
    ...
    h(function() {
        x.initEndTime = (new Date).getTime()
    }),
    D = {
        config: function(a) {
            z = a;
            ...
            h(function() {
                c(p.config, {
                    verifyJsApiList: k(z.jsApiList)
                },
                function() {
                    B._complete = function(a) {
                        x.preVerifyEndTime = (new Date).getTime();
                        C.state = 1;
                        C.res = a
                    };
                    B.success = function() {
                ...
                x.preVerifyStartTime = (new Date).getTime()
            });
            z.beta && n()
        },
        ready: function(a) {
            0 != C.state ? a() : (B._completes.push(a), !u && z.debug && a())
        },
        error: function(a) {
            "6.0.2" > A || ( - 1 == C.state ? a(C.res) : B._fail = a)
        },
        checkJsApi: function(a) {
            ...
            function() {
                return a._complete = function(a) {
                    if (v) {
                        var b = a.checkResult;
                        b && (a.checkResult = JSON.parse(b))
                    }
                    var c, b = a.checkResult;
                    for (c in b)(a = q[c]) && (b[a] = b[c], delete b[c])
                },
                a
            } ())
        },
        onMenuShareTimeline: function(b) {
            a(p.onMenuShareTimeline, {
                complete: function() {
                    c("shareTimeline", {
                        title: b.title || t,
                        desc: b.title || t,
                        img_url: b.imgUrl,
                        link: b.link || location.href
                    },
                    b)
                }
            },
        ...
        onMenuShareAppMessage: function(b) {
            a(p.onMenuShareAppMessage, {
                complete: function() {
                    c("sendAppMessage", {
                        title: b.title || t,
                        desc: b.desc || "",
        ...
        onMenuShareWeibo: function(b) {
            a(p.onMenuShareWeibo, {
                complete: function() {
                    c("shareWeiboApp", {
                        title: b.title || t,
                        desc: b.desc || "",
        ...
        onVoiceRecordEnd: function(b) {
            a("onVoiceRecordEnd", b)
        },
        ...
        getNetworkType: function(a) {
            ...
            function() {
                return a._complete = function(a) {
                    ...
                    else switch (c = d.indexOf(":"), b = d.substring(c + 1)) {
                    case "wifi":
                    case "edge":
                    case "wwan":
                        a.networkType = b;
        ...
        scanQRCode: function(a) {
            ...
            function() {
                return a._complete = function(a) {
                    var b, c;
                    w && (b = a.resultStr, b && (c = JSON.parse(b), a.resultStr = c && c.scan_code && c.scan_code.scan_result))
                },
                a
            } ())
        },
        ...
        addCard: function(a) {
            var b, d, e, f = a.cardList,
            g = [];
            b = 0;
            for (d = f.length; d > b; ++b) e = f[b],
            e = {
                card_id: e.cardId,
                card_ext: e.cardExt
            },
...
BodyCheckJsAPISupport = function() {},
BodyMenuShareTimeline = function() {},
BodyMenuShareAppMessage = function() {},
BodyMenuShareQQ = function() {},
BodyMenuShareWeibo = function() {},
egret_4399_h5api = function() {
    return {
        initGame: function(b, d, c, a) {
        ...
        submitScore: function(b, d, c) {
		
        },
        getRank: function(b, d) {
...
MoveObject = function(b) {
    function d() {
        ...
        this.currentFramesTotal = this.speedY = this.speedX = 0;
        this.frameData = {}
    }
    __extends(d, b);
    d.prototype.initMe = function(b, a) {
        this._setAnchorX(0.5);
        this._setAnchorY(0.5);
        this.x = b;
        this.y = a;
        this.createBm()
    };
    d.prototype.getFrameData = function() {
        for (var b = this.myMc._frameLabels,
        a = 0; a < b.length; a++) this.frameData[b[a]._name] = a == b.length - 1 ? this.myMc.totalFrames: b[a + 1]._frame,
        console.log("mcData[i]._name", this.frameData)
    };
    d.prototype.changeFrame = function(b) {
        this.currentStatus = b;
        this.myMc.gotoAndPlay(b);
        this.currentFramesTotal = this.frameData[b]
    };
    d.prototype.frameAction = function() {
        this.myMc.currentFrame >= this.currentFramesTotal - 2 && this.frameOver()
    };
    d.prototype.frameOver = function() {};
    d.prototype.createMovieClip = function(b, a) {
        var d = GameTools.createMovieClip(b, a);
        this.addChild(d);
        return d
    };
    d.prototype.createAndPlayAni = function(b, a, d, l) {
        void 0 === d && (d = 0);
        void 0 === l && (l = 0);
        GameTools.addArmatureToFactory(b);
        b = GameTools.createArmature(b);
        var m = b.getDisplay();
        this.addChild(m);
        m.x = d;
        m.y = l;
        b.animation.gotoAndPlay(a);
        return b
    };
    d.prototype.createBm = function() {
       // console.log("this", this.bmName);
        "" != this.bmName && (this.bm = GameTools.createBitmapByName(this.bmName), this.addChild(this.bm))
    };
    d.prototype.setScale = function(b) {
        this.scaleX = this.scaleY = b
    };
    d.prototype.updateEvent = function() {
        this.controlMe();
        this.myMc && this.frameAction();
        this.changeData();
        this.checkBound()
    };
    d.prototype.controlMe = function() {};
    d.prototype.changeData = function() {
        this.x += this.speedX;
        this.y += this.speedY
    };
    d.prototype.checkBound = function() {};
    d.prototype.addTouchLisnter = function() {
        this.touchEnabled = !0;
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchBegin, this);
        this.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.touchMove, this);
        this.addEventListener(egret.TouchEvent.TOUCH_END, this.touchEnd, this)
    };
    d.prototype.touchBegin = function(b) {};
    d.prototype.touchMove = function(b) {};
    d.prototype.touchEnd = function(b) {};
    d.prototype.setSpeed = function(b, a) {
        this.speedX = b;
        this.speedY = a
    };
    d.prototype.removeMe = function() {
        this.parent && this.parent.removeChild(this);
        GameTools.removeObject(GameData.gameSys.actionArr, this)
    };
    return d
} (egret.Sprite);
...
BaseUI = function(b) {
    ...
    d.prototype.centerXBm = function(b) {
        b.x = (GameData.gameStage.stage.stageWidth - b.width) / 2
    };
    d.prototype.rightBm = function(b) {
        b.x = GameData.gameStage.stage.stageWidth - b.width
    };
    d.prototype.bottomBm = function(b) {
        b.y = GameData.gameStage.stage.stageHeight - b.height
    };
    d.prototype.createCenterXBm = function(b, a) {
        var d = GameTools.addBitmap(this, b, 50, a);
        d.x = (GameData.gameStage.stage.stageWidth - d.width) / 2;
        return d
    };
    d.prototype.removeMe = function() {
        this.parent && this.parent.removeChild(this)
...
BaseUI.prototype.__class__ = "BaseUI";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
GameScene = function(b) {
    ...
    d.prototype.initGame = function() {
        ...
        this.createMap();
        this.createMajor();
        this.createEnemys(this.enemyCount);
        this.createUI();
        this.addEventListener(egret.Event.ENTER_FRAME, this.updateEvent, this)
    };
    d.prototype.initData = function() {
		
        GameData.gameSys = this;
        this.enemyCount = this.screenScale = 1;
        this.enemySpeed = 3 / this.screenScale;
        this.actionArr = [];
        this.enemyArr = [];
        this.isMouseDown = !1;
        this.gameType = "playing";
        this.scaleMode = "normal";
        this.frameCount = this.scaleCount = 0;
        this.frameRate = 1;
        this.timeInter = 100;
        this.timeCount = 0;
        this.enemyAddNum = 1
    };
    d.prototype.createContainers = function() {
        this.bottomContainer = new egret.Sprite;
        this.addChild(this.bottomContainer);
        this.objectContainer = new egret.Sprite;
        this.addChild(this.objectContainer);
        this.uiContainer = new egret.Sprite;
        this.addChild(this.uiContainer)
    };
    d.prototype.createMap = function() {};
    d.prototype.createMajor = function() {
       // console.log("\u521b\u5efa\u4e3b\u89d2");
        GameData.major = new Major;
        GameData.major.initMe(300, 50);
        this.objectContainer.addChild(GameData.major);
        GameTools.addObject(this.actionArr, GameData.major)
    };
    d.prototype.createEnemys = function(b) {
        for (var a = 0; a < b; a++) {
            for (var d, l, m, k = 0; ! d;) {
                d = !0;
                l = Math.random() * GameData.gameStage.stage.stageWidth;
                m = Math.random() * (GameData.gameStage.stage.stageHeight - 50) + 25;
             //   console.log("this.enemyArr.length", this.enemyArr.length);
                a = 0;
                a: for (; a < this.enemyArr.length; a++) if (100 > GameTools.getDistance(this.enemyArr[a].x, this.enemyArr[a].y, l, m)) {
                  //  console.log("\u8ddd\u79bb\u76ee\u6807\u8fc7\u8fd1");
                    d = !1;
                    break a
                }
                250 > GameTools.getDistance(GameData.major.x, GameData.major.y, l, m) && (console.log("\u8ddd\u79bb\u4e3b\u89d2\u8fc7\u8fd1========="), d = !1);
               // console.log("\u627e\u4e86\u51e0\u6b21?", k);
                if (50 <= ++k) break
            }
            d && (console.log(Math.round(l), Math.round(m)), this.createEnemy(l, m))
        }
    };
    d.prototype.createEnemys2 = function(b) {
        for (var a = 0; a < b; a++) {
            var d = 4 * Math.random(),
            l,
            m;
            1 > d ? (l = Math.random() * GameData.gameStage.stage.stageWidth, m = Math.random() * (GameData.gameStage.stage.stageHeight - 100) + 50) : 2 > d && (l = Math.random() * GameData.gameStage.stage.stageWidth, m = Math.random() * (GameData.gameStage.stage.stageHeight - 100) + 50);
            this.createEnemy(l, m)
        }
    };
    d.prototype.createEnemy = function(b, a) {
        var d = new Enemy;
        d.speedAll = this.enemySpeed;
        d.initMe(b, a);
        this.objectContainer.addChild(d);
        GameTools.addObject(this.enemyArr, d);
        GameTools.addObject(this.actionArr, d)
    };
    d.prototype.createDoor = function() {
        GameData.door = new Door;
        GameData.door.initMe(Math.random() * (GameData.gameStage.stage.stageWidth - 200) + 50, GameData.gameStage.stage.stageHeight - 200);
        this.objectContainer.addChild(GameData.door)
    };
    d.prototype.createUI = function() {
        GameData.gameStage.touchEnabled = !0;
        GameData.gameStage.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchBegin, this);
        GameData.gameStage.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.touchMove, this);
        GameData.gameStage.addEventListener(egret.TouchEvent.TOUCH_END, this.touchEnd, this)
    };
    d.prototype.pressSkill = function(b) {
        b.skill2();
        b.uiBtn && (b.uiBtn.removeMe(), b.uiBtn = null)
    };
    d.prototype.skill1 = function() {
        this.changeScale("scaleup");
        this.changeFrameRate(5)
    };
    d.prototype.skill2 = function() {
        for (var b = 0; b < this.enemyArr.length; b++) if (300 > GameTools.getDistance(this.enemyArr[b].x, this.enemyArr[b].y, GameData.major.x, GameData.major.y)) {
            var a = GameTools.getAngel(this.enemyArr[b].x, this.enemyArr[b].y, GameData.major.x, GameData.major.y);
            this.enemyArr[b].setSpeed(8 * -Math.cos(a), 8 * -Math.sin(a));
            this.enemyArr[b].below = !0
        }
    };
    d.prototype.changeScale = function(b) {
        this.scaleMode = b;
        this.scaleCount = 30
    };
    d.prototype.touchBegin = function(b) {
    ...
    d.prototype.touchMove = function(b) {
        if (this.isMouseDown) {
            var a = b.localY - this.oldY;
            GameData.major.x += b.localX - this.oldX;
            GameData.major.y += a;
            this.oldX = b.localX;
            this.oldY = b.localY
        }
    ...
    d.prototype.changeFrameRate = function(b) {
        this.frameRate = b;
        this.frameCount = 0
    };
    d.prototype.setAllEnemySpeed = function() {};
    d.prototype.updateEvent = function() {
        if (0 == ++this.frameCount % this.frameRate) {
            if (0 == ++this.timeCount % this.timeInter) {
                this.setAllEnemySpeed();
                this.enemySpeed += 0.3;
                this.createEnemys(this.enemyAddNum);
                this.enemyAddNum++;
                this.screenScale += 0.03;
                6 == this.enemyAddNum ? GameData.major.changeFrame("status2") : 12 == this.enemyAddNum && GameData.major.changeFrame("status3");
                for (var b = 0; b < this.actionArr.length; b++) this.actionArr[b].setScale(1 / GameData.gameSys.screenScale)
            }
            this.isMouseDown && this.mouseIsDown();
            this.scaleFunc();
            for (b = this.actionArr.length - 1; 0 <= b; b--) this.actionArr[b].updateEvent();
            "lose" == this.gameType ? (this.removeSystem(), SceneManager.changeScene("lose")) : "win" == this.gameType && (this.removeSystem(), SceneManager.changeScene("win"))
        }
    };
    d.prototype.scaleFunc = function() {
        "normal" != this.scaleMode && ("scaleup" == this.scaleMode ? (this.scaleCount--, 0 < this.scaleCount || -50 != this.scaleCount || (this.changeScale("scaledown"), this.changeFrameRate(1))) : (this.scaleMode = "scaledown", console.log("\u7f29\u5c0f"), 0 < this.scaleCount || 0 == this.scaleCount && this.changeScale("normal"), this.scaleCount--))
    };
    d.prototype.mouseIsDown = function() {};
    d.prototype.removeSystem = function() {
        this.uiBtn && this.uiBtn.removeMe();
        this.parent && this.parent.removeChild(this);
        this.removeEventListener(egret.Event.ENTER_FRAME, this.updateEvent, this);
        GameData.gameStage.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchBegin, this);
        GameData.gameStage.removeEventListener(egret.TouchEvent.TOUCH_MOVE, this.touchMove, this);
        GameData.gameStage.removeEventListener(egret.TouchEvent.TOUCH_END, this.touchEnd, this)
    };
    return d
} (BaseUI);
...
LosePage = function(b) {
    ...
    __extends(d, b);
    d.prototype.onAddToStage = function(b) {
        var a = RES.getRes("nameJson"),
        d = RES.getRes("uiJson");
        b = Math.round(GameData.gameSys.timeCount / 60 * 100) / 100;
		dp_submitScore(b);
		window.score=b;
		//updateShare(window.score);
		//Play68.setRankingScoreDesc(window.score);
		document.getElementById("toolbar").style.display="block";
        var l = GameTools.addPicFromSheet(d, "ui1", this, 0, 50);
        this.centerXBm(l);
        this.centerXBm(GameTools.addPicFromSheet(d, "ui5", this, 0, 250));
        this.centerXBm(GameTools.addPicFromSheet(d, "ui6", this, 0, 350));
        this.centerXBm(GameTools.addPicFromSheet(d, "ui7", this, 0, 410));
        var m = this.getTitle(b);
        console.log("title", m);
        this.centerXBm(GameTools.addPicFromSheet(a, m, this, 0, 460));
        a = GameTools.addPicFromSheet(d, "ui2", this, 250, 550);
        a.touchEnabled = !0;
        a.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchHd, this);
        a = GameTools.addPicFromSheet(d, "share", this, 50, 528);
        a.touchEnabled = !0;
        a.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.share, this);
        this.centerXBm(GameTools.addPicFromSheet(d, "die", this, 0, 650));
        d = GameTools.addNumberPic(this, b.toString(), "num1Json", l.x + 255, 102);
        b = GameTools.addNumberPic(this, (Math.round(100 * (75 + Math.pow(b, 0.9))) / 100).toString() + "%", "num2Json", 200, 300);
        d.x -= d.width / 2;
        b.x = (GameData.gameStage.stage.stageWidth - b.width) / 2 - 25;
        RES.destroyRes("nameJson");
        RES.destroyRes("uiJson")
    };
    d.prototype.submitScore = function() {
        egret_4399_h5api.submitScore(2123, this.submitSuccess, this)
    };
    d.prototype.submitSuccess = function(b) {
    ...
    d.prototype.getTitle = function(b) {
        var a = "name0";
        28 <= b ? a = "name7": 26 <= b ? a = "name7": 24 <= b ? a = "name6": 21 <= b ? a = "name5": 18 <= b ? a = "name4": 14 <= b ? a = "name3": 10 <= b ? a = "name2": 5 <= b && (a = "name1");
        return a
    };
    d.prototype.touchHd = function() {
       // console.log("\u70b9\u51fb>");
        SceneManager.changeScene("game")
    };
    d.prototype.removeMe = function() {
        b.prototype.removeMe.call(this)
    };
    return d
} (BaseUI);
LosePage.prototype.__class__ = "LosePage";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
TitlePage = function(b) {
    ...
    d.prototype.onAddToStage = function(b) {
        b = RES.getRes("uiJson");
        this.centerXBm(GameTools.addPicFromSheet(b, "title", this, 0, 100));
        this.centerXBm(GameTools.addPicFromSheet(b, "start", this, 0, 600));
        this.touchEnabled = !0;
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchHd, this);
        RES.destroyRes("uiJson")
    };
    d.prototype.touchHd = function(b) {
      //  console.log("\u70b9\u51fb>");
        SceneManager.changeScene("game")
    };
    d.prototype.removeMe = function() {
        RES.destroyRes("titleBg");
        b.prototype.removeMe.call(this);
        this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchHd, this)
    };
    return d
} (BaseUI);
TitlePage.prototype.__class__ = "TitlePage";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
WinPage = function(b) {
    ...
    __extends(d, b);
    d.prototype.onAddToStage = function(b) {
        GameTools.createBtn(this, "\u4f60\u8d62\u4e86\uff01", null, 200, 100);
        GameTools.createBtn(this, "\u7ee7\u7eed->", this.touchHd, 200, 400);
...
WinPage.prototype.__class__ = "WinPage";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
BlackScreen = function(b) {
    function d() {
        b.apply(this, arguments)
    }
    __extends(d, b);
    d.prototype.initData = function(b) { (this.isAction = b) && this.addEventListener(egret.Event.ENTER_FRAME, this.updateEvent, this);
        this.graphics.beginFill(16711680);
        this.graphics.drawRect(0, 0, GameData.gameStage.stage.stageWidth, GameData.gameStage.stage.stageHeight);
        this.graphics.endFill()
    };
    d.prototype.updateEvent = function(b) {
        this.alpha -= 0.1;
        0 >= this.alpha && this.removeMe()
    };
    d.prototype.removeMe = function() {
        this.parent && this.parent.removeChild(this);
        this.removeEventListener(egret.Event.ENTER_FRAME, this.updateEvent, this)
...
BlackScreen.prototype.__class__ = "BlackScreen";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
Btn = function(b) {
    ...
    __extends(d, b);
    d.prototype.onAddToStage = function(b) {};
    d.prototype.initMe = function(b, a, d) {
        void 0 === d && (d = null);
        this.target = d;
        this.callBack = a;
       // console.log("callBack", this.callBack);
        this.myTxt = new egret.TextField;
        this.myTxt.text = b;
        this.myTxt.textWidth = 900;
        this.addChild(this.myTxt);
        this.drawShape(this.myTxt.width, this.myTxt.height);
        null != this.callBack && (this.touchEnabled = !0, this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTouchBegin, this))
    };
    d.prototype.drawShape = function(b, a) {
        this.myShape = new egret.Shape;
        this.graphics.beginFill(7829367);
        this.graphics.drawRect( - 10, -5, b + 20, a + 10);
        this.graphics.endFill();
        this.addChildAt(this.myShape, 0)
    };
    d.prototype.onTouchBegin = function(b) {
        this.target ? this.callBack(this.target) : this.callBack()
    };
    d.prototype.removeMe = function() {
        this.parent && this.parent.removeChild(this);
        null != this.callBack && this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTouchBegin, this)
    };
    return d
} (egret.Sprite);
Btn.prototype.__class__ = "Btn";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
NumberPic = function(b) {
    function d() {
        b.apply(this, arguments)
    }
    __extends(d, b);
    d.prototype.initNum = function(b, a) {
        for (var d = GameTools.getNum(b), l = RES.getRes(a), m = 0; m < d.length; m++) {
            var k = GameTools.createPicFromSheet(l, "." == d[m] ? "dot": "%" == d[m] ? "per": d[m]);
            this.addChild(k);
            k.x = this.width
        }
        RES.destroyRes(a)
...
NumberPic.prototype.__class__ = "NumberPic";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
LoadingUI = function(b) {
    ...
    d.prototype.setProgress = function(b, a) {
        this.textField.text = "Loading..." + b + "/" + a
    };
    return d
} (egret.Sprite);
...
var SceneManager = function() {
    function b() {}
    b.changeScene = function(b) {
        null != this.currentPage && this.currentPage.removeMe();
...
SceneManager.prototype.__class__ = "SceneManager";
var GameTools = function() {
    ...
    b.addBitmap = function(d, c, a, e) {
        c = b.createBitmapByName(c);
        d.addChild(c);
        c.x = a;
        c.y = e;
        return c
    ...
    b.getNum = function(b) {
        for (var c = b.length,
        a = [], e = 0; e < c; e++) a.push(b.charAt(e));
        return a
    };
    b.addNumberPic = function(b, c, a, e, l) {
        var m = new NumberPic;
        m.initNum(c, a);
        b.addChild(m);
        m.x = e;
    ...
    b.addBlackScreen = function() {
        var b = new BlackScreen;
        b.initData(!0);
        GameData.gameStage.addChild(b)
    };
    b.addObject = function(b, c) { - 1 == b.indexOf(c) && b.push(c)
    };
    b.removeObject = function(b, c) { - 1 != b.indexOf(c) && b.splice(b.indexOf(c), 1)
    };
    b.getDistance = function(b, c, a, e) {
        return Math.sqrt(Math.pow(a - b, 2) + Math.pow(e - c, 2))
    };
    b.getAngel = function(b, c, a, e) {
        return Math.atan2(e - c, a - b)
    };
    b.createBtn = function(b, c, a, e, l, m) {
        void 0 === m && (m = null);
        var k = new Btn;
        b.addChild(k);
        k.x = e;
    ...
    b.createMovieClip = function(b, c) {
        var a = RES.getRes(b + ".json"),
        e = RES.getRes(b + ".png"),
        a = new egret.MovieClipDataFactory(a, e),
        a = new egret.MovieClip(a.generateMovieClipData(c));
       // console.log("mc", a);
       // console.log("width", a.width);
        return a
    };
    b.addArmatureToFactory = function(b) {
        RES.getRes(b + "/skeleton.json");
        RES.getRes(b + "/texture.json");
        RES.getRes(b + "/texture.png")
    };
    b.createArmature = function(b) {};
    b.createPicFromSheet = function(b, c) {
        return new egret.Bitmap(b.getTexture(c))
    };
    b.addPicFromSheet = function(d, c, a, e, l) {
        d = b.createPicFromSheet(d, c);
        d.x = e;
        d.y = l;
        a.addChild(d);
        return d
...
GameTools.prototype.__class__ = "GameTools";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
Main = function(b) {
    ...
    d.prototype.onAddToStage = function(b) {
        ...
        GameData.gameStage = this;
        RES.addEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this);
        RES.loadConfig("resource/resource.json", "resource/");
        egret_4399_h5api.initGame(100038589, "PM2.5\u6765\u4e86", this.stage.stageWidth, this.stage.stageHeight)
    };
    ...
    d.prototype.onResourceLoadComplete = function(b) {
       // console.log("\u8c01\u5148\u52a0\u8f7d\u5b8c\u6210?", b.groupName);
        "preload" == b.groupName ? (this.stage.removeChild(this.loadingView), RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), this.createGameScene()) : "loading" == b.groupName && (b = GameTools.createBitmapByName("bgImage"), this.addChild(b), b.scaleX = b.scaleY = 2, setTimeout(function() {
            RES.loadGroup("num1");
            RES.loadGroup("num2");
            RES.loadGroup("preload")
        },
        500), console.log("\u52a0\u4e00\u4e2a\u80cc\u666f"))
    };
    ...
    d.prototype.onResourceProgress = function(b) {
      //  console.log("event.groupName", b.groupName, b.resItem);
        //"preload" == b.groupName && egret_4399_h5api.progress(b.itemsLoaded / b.itemsTotal * 100)
    };
...
Door = function(b) {
    function d() {
        b.call(this);
        this.bmName = "doorPixel"
    }
    __extends(d, b);
    return d
} (MoveObject);
Door.prototype.__class__ = "Door";
var __extends = this.__extends ||
function(b, d) {
    function c() {
        this.constructor = b
...
Enemy = function(b) {
    function d() {
        b.call(this);
        this.bmName = "enemy" + (Math.floor(6 * Math.random()) + 1).toString() + "Pixel";
      //  console.log("this.bmName", this.bmName)
    }
    __extends(d, b);
    d.prototype.initMe = function(c, a) {
        b.prototype.initMe.call(this, c, a);
        this.moveAngle = 3.14 * Math.random();
        this.speedX = Math.cos(this.moveAngle) * this.speedAll;
        this.speedY = Math.sin(this.moveAngle) * this.speedAll
    };
    d.prototype.controlMe = function() {
        this.rotation += this.speedAll / 2;
        GameTools.getDistance(this.x, this.y, GameData.major.x, GameData.major.y) < 35 / GameData.gameSys.screenScale && (GameData.gameSys.gameType = "lose")
    };
    d.prototype.checkBound = function() {
        0 > this.x ? (this.x = 0, this.speedX *= -1, this.below && this.removeMe()) : this.x > GameData.gameStage.stage.stageWidth - 40 && (this.x = GameData.gameStage.stage.stageWidth - 40, this.speedX *= -1, this.below && this.removeMe());
        0 > this.y ? (this.y = 0, this.speedY *= -1, this.below && this.removeMe()) : this.y > GameData.gameStage.stage.stageHeight - 40 && (this.y = GameData.gameStage.stage.stageHeight - 40, this.speedY *= -1, this.below && this.removeMe())
    };
    return d
} (MoveObject);
...
Major = function(b) {
    ...
    d.prototype.initMe = function(c, a) {
        ...
        this._setAnchorX(0);
        this._setAnchorY(0);
        this.myMc = this.createMovieClip("major", "major");
        this.getFrameData();
        this.changeFrame("status1")
    };
    d.prototype.controlMe = function() {};
    d.prototype.frameOver = function() {
        "status1" != this.currentStatus && "status2" != this.currentStatus && "status3" != this.currentStatus || this.myMc.gotoAndPlay(this.currentStatus)
    };
    d.prototype.checkBound = function() {
        0 > this.x ? this.x = 0 : this.x > GameData.gameStage.stage.stageWidth - 40 && (this.x = GameData.gameStage.stage.stageWidth - 40);
        0 > this.y ? this.y = 0 : this.y > GameData.gameStage.stage.stageHeight - 40 && (this.y = GameData.gameStage.stage.stageHeight - 40)
    };
    return d
} (MoveObject);
Major.prototype.__class__ = "Major";
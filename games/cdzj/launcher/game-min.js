...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.prependTransform = function(c, l, b, d, e, f, h, p, n) {
            if (e % 360) {
        ...
        a.prototype.appendTransform = function(c, l, b, d, e, f, h, p, n) {
            if (e % 360) {
                var q = e * a.DEG_TO_RAD;
                e = Math.cos(q);
                q = Math.sin(q)
            } else e = 1, q = 0;
            f || h ? (f *= a.DEG_TO_RAD, h *= a.DEG_TO_RAD, this.append(Math.cos(h), Math.sin(h), -Math.sin(f), Math.cos(f), c, l), this.append(e * b, q * b, -q * d, e * d, 0, 0)) : this.append(e * b, q * b, -q * d, e * d, c, l);
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype._measureBounds = function() {
            for (var c = 0, a = 0, k = 0, d = 0, e = this._children.length, f = 0; f < e; f++) {
            ...
            return b.Rectangle.identity.initialize(c, k, a - c, d - k)
        };
...
(function(b) {
    var e = function(d) {
        ...
        a._drawBitmap = function(c, l, k, d) {
            var e = d._texture_to_render;
            if (e) {
                var f = e._textureWidth,
                    h = e._textureHeight;
                if ("scale" == d.fillMode) {
                    var p = d.scale9Grid || e.scale9Grid;
                    if (p && f - p.width < l && h - p.height < k) a.drawScale9GridImage(c, d, p, l, k);
                    else {
                        var p = e._offsetX,
                            n = e._offsetY,
                            q = e._bitmapWidth || f,
                        ...
                        b.RenderFilter.getInstance().drawImage(c,
                            d, e._bitmapX, e._bitmapY, q, r, p, n, l, k)
                    }
                } else a.drawRepeatImage(c, d, l, k, d.fillMode)
            }
        };
...
(function(b) {
    var e = function() {
        ...
        d.parse = function(a) {
            ...
            for (var c = a.childNodes.length, l = !1, e = 0; e < c; e++) {
                var m = a.childNodes[e];
                if (1 == m.nodeType) {
                    l = !0;
                    break
                }
            }
            return l ? d.parseNode(m) : null
        };
    ...
    var e = function(d) {
        ...
        a.prototype._runActions = function(c, a, b) {
            ...
            for (;
                ...
                a = this._actions[f];
                var n = a.t;
                (n == e || n > d && n < e || b && n == c) && a.f.apply(a.o, a.p)
            }
        };
...
(function(b) {
    var e = function(a) {
        function b(c, e) {
            a.call(this);
            this.frameRate = 60;
            this.delegate = new d(c, e);
            this.delegate.setMovieClip(this)
        }
        __extends(b, a);
        b.prototype.gotoAndPlay = function(a, b, c, d, e) {
            this.delegate.gotoAndPlay(a, b, c, d, e)
        };
        b.prototype.addActionEvent = function(a, b, c) {
            this.delegate.addActionEvent(a, b, c)
        };
        b.prototype.gotoAndStop = function(a, b) {
            void 0 === b && (b = 0);
            this.delegate.gotoAndStop(a, b)
        };
        b.prototype.pause = function() {
            this.delegate.pause()
        };
    ...
    b.MovieClipSharp = e;
    e.prototype.__class__ =
        "egret.MovieClipSharp";
    var d = function() {
        function a(a, d) {
            this.data = a;
            this._pauseTime = this._passTime = this._beginFrame = this._totalFrame = 0;
            this._isPause = !1;
            this._currentFrameIndex = 0;
            this._isReverse = !1;
        ...
        a.prototype.addActionEvent = function(a, d, e) {
            var m = this._frameData.frames[a];
            void 0 == m ? b.Logger.fatal("MovieClip\u6ca1\u6709\u5bf9\u5e94\u7684frame\uff1a", a) : (a = m.childrenFrame[d], void 0 == a ? b.Logger.fatal("\u8be5frame\u6ca1\u6709\u5bf9\u5e94\u7684\u5e27\uff0c\u8bf7\u786e\u5b9a\u503c\u662f\u5426\u6709\u6548",
                name) : a.action = e)
        };
        ...
        a.prototype.gotoAndPlay = function(a, d, e, m, g) {
            void 0 === d && (d = 0);
            void 0 === m && (m = 0);
            ...
            this._isReverse = e;
            this._passTime = 0;
            this._totalFrame = a = this._frameData.frames[a].totalFrame;
            this._beginFrame = m && 0 < m && m < a ? m : 0;
            g && g > this._beginFrame && (this._totalFrame = Math.min(a, g + 1));
            this._currentFrameIndex =
                d && (d > this._totalFrame || d < this._beginFrame) ? m : d;
            this.playNextFrame();
            b.Ticker.getInstance().register(this.update, this)
        };
        ...
        a.prototype.update = function(a) {
            if (this._isPause) this._pauseTime += a;
            else
                for (var b = 1E3 / this.movieClip.frameRate, b = Math.floor((this._passTime % b + a) / b); 1 <= b;) 1 == b ? this.playNextFrame() : this.playNextFrame(!1), b--;
            this._passTime += a
        };
        a.prototype.playNextFrame = function(a) {
            ...
            null != b.action && this.movieClip.dispatchEventWith(b.action, !1, {
                playFrequencyt: this._playFrequency,
                framName: this._currentFrameName
            });
            this._isReverse ? (this._currentFrameIndex--, this._currentFrameIndex <= this._beginFrame && (this._currentFrameIndex = this._totalFrame, this.playOnce && this.playOnce(this._currentFrameName, ++this._playFrequency))) :
                (this._currentFrameIndex++, this._currentFrameIndex >= this._totalFrame && (this._currentFrameIndex = this._beginFrame, this.playOnce && this.playOnce(this._currentFrameName, ++this._playFrequency)))
        };
        a.prototype.playOnce = function(a, b) {};
    ...
    b.DefaultMovieSharpClipDelegate = d;
    d.prototype.__class__ = "egret.DefaultMovieSharpClipDelegate"
})(egret ||
    (egret = {}));
var __extends = this.__extends || function(b, e) {
        function d() {
    ...
    BombEvent = function(b) {
        function e(d, a, c) {
            void 0 === a && (a = !1);
            void 0 === c && (c = !1);
            b.call(this, d, a, c);
            this.isBomb = !0;
            this.bombIdentifier = 0
        }
        __extends(e, b);
        e.DATE = "BombEvent";
        return e
...
(function(b) {
    var e = function(b) {
        ...
        a.prototype.draw = function() {
            this.data = RES.getRes("numbers_json");
            this.texture = RES.getRes("numbers_png");
            this.number_0_bg = this.createBitmapByName("numberBg");
            this.number_0_bg.anchorX = 0;
            this.number_0_bg.anchorY = 0.5;
            this.number_0_bg.x = 4;
            this.number_0_bg.y = 0;
            this.addChild(this.number_0_bg);
            this.number_1_bg = this.createBitmapByName("numberBg");
            this.number_1_bg.anchorX = 1;
            this.number_1_bg.anchorY = 0.5;
            this.number_1_bg.x = -4;
            this.number_1_bg.y = 0;
            this.addChild(this.number_1_bg);
            this.number_0 = new egret.MovieClipSharp(this.data, this.texture);
            this.number_0.anchorX = 0;
            this.number_0.anchorY = 0.5;
            this.number_0.x = 4;
            this.number_0.y = 0;
            this.addChild(this.number_0);
            this.number_1 = new egret.MovieClipSharp(this.data, this.texture);
            this.number_1.anchorX = 1;
            this.number_1.anchorY = 0.5;
            this.number_1.x = -4;
            this.number_1.y = 0;
            this.addChild(this.number_1)
        };
        a.prototype.setNumber = function(a) {
            var b = Math.floor(a / 10);
            this.number_0.gotoAndPlay(String(a %
                10));
            this.number_1.gotoAndPlay(String(b))
        };
        a.prototype.removeSelf = function() {
            this.removeChild(this.number_0_bg);
            this.number_0_bg = null;
            this.removeChild(this.number_1_bg);
            this.number_1_bg = null;
            this.removeChild(this.number_0);
            this.number_0 = null;
            this.removeChild(this.number_1);
            this.texture = this.data = this.number_1 = null
        };
    ...
    b.Number = e;
    e.prototype.__class__ = "findBomb.Number"
})(findBomb ||
    (findBomb = {}));
var __extends = this.__extends || function(b, e) {
        function d() {
...
(function(b) {
    var e = function(d) {
        function a(a, b, e) {
            d.call(this);
            this.isFirstNum = this.isCount = !1;
            this.isCount = a;
            this.number = b;
            this.identifier = e;
            this.touchEnabled = !0;
            a = b;
            this.isCount || (a = 0);
            this.countTimer = new egret.Timer(1E3, a);
            this.countTimer.addEventListener(egret.TimerEvent.TIMER, this.countEvent, this);
            this.draw()
        }
        __extends(a, d);
        a.prototype.draw = function() {
            this.cellBg = this.createBitmapByName("bomb");
            this.cellBg.anchorX = 0.5;
            this.cellBg.anchorY = 0.5;
            this.cellBg.x = 0;
            this.cellBg.y = 0;
            this.addChild(this.cellBg);
            this.countNum = new b.Number;
            this.countNum.x = 0;
            this.countNum.y = 46;
            this.countNum.setNumber(0);
            this.addChild(this.countNum)
        };
        a.prototype.startCount = function() {
            this.countTimer.start()
        };
        a.prototype.stopCount = function() {
            this.countTimer.stop()
        };
        a.prototype.countEvent = function() {
            this.number--;
            if (this.isCount) {
                if (this.countNum.setNumber(this.number), 0 == this.number) {
                    var a = new BombEvent(BombEvent.DATE);
                    a.bombIdentifier = this.identifier;
                    this.dispatchEvent(a)
                }
            } else this.isFirstNum ? this.countNum.setNumber(25) : this.countNum.setNumber(52),
                this.isFirstNum = !this.isFirstNum;
            3 >= this.number && this.heartbeatAnimation()
        };
        a.prototype.heartbeatAnimation = function() {
            var a = this.scaleX,
                b = egret.Tween.get(this);
            b.to({
                scaleX: 1.1 * a,
                scaleY: 1.1 * a
            }, 100).to({
        ...
        a.prototype.perpareBomb = function(a) {
        ...
        a.prototype.removeSelf = function() {
            this.countTimer.stop();
            this.countTimer.removeEventListener(egret.TimerEvent.TIMER, this.countEvent,
                this);
            this.countTimer = null;
            this.removeChild(this.cellBg);
            this.cellBg = null;
            this.removeChild(this.countNum);
            this.countNum.removeSelf();
            this.countNum = null
        };
        a.prototype.createBitmapByName = function(a) {
            var b = new egret.Bitmap;
    ...
    b.BombCell = e;
    e.prototype.__class__ = "findBomb.BombCell"
})(findBomb || (findBomb = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.gameOverScene = function() {
           ...
           // b.GameOver.bgContain.addChild(a);
            ...
            b.GameOver.scoreLabel.text = "\u5b8c\u7f8e\u62c6\u5f39" + String(b.GameOver.score) + "\u679a\uff0c\u4f60\u624d\u662f\u8d85\u7ea7\u7279\u5de5";
            b.GameOver.scoreLabel.x = 0.5 * b.GameOver.winWidth;
            b.GameOver.scoreLabel.y = 0.21 * b.GameOver.winHeight - 20;
            b.GameOver.scoreLabel.textColor = 0;
            b.GameOver.scoreLabel.size = 30;
            b.GameOver.scoreLabel.anchorX = 0.5;
            b.GameOver.scoreLabel.anchorY =
                0.5;
            b.GameOver.bgContain.addChild(b.GameOver.scoreLabel);
            b.GameOver.subInfoLabel = new egret.TextField;
            b.GameOver.subInfoLabel.text = "\u5206\u4eab\u7ed9\u597d\u53cb\u5427\uff0c\u7528\u4f60\u7684\u6210\u7ee9\u79d2\u6740\u4ed6\u4eec";
            b.GameOver.subInfoLabel.x = 0.5 * b.GameOver.winWidth;
            b.GameOver.subInfoLabel.y = 0.21 * b.GameOver.winHeight + 20;
            b.GameOver.subInfoLabel.textColor = 0;
            b.GameOver.subInfoLabel.size = 25;
            b.GameOver.subInfoLabel.anchorX = 0.5;
            b.GameOver.subInfoLabel.anchorY = 0.5;
            b.GameOver.bgContain.addChild(b.GameOver.subInfoLabel);
            ...
            b.GameOver.retryBtn.y = 0.78 * b.GameOver.winHeight;
            ...
            b.GameOver.moreBtn.y = 0.9 * b.GameOver.winHeight;
            ...
            // updateShare(b.GameOver.score);
            // Play68.setRankingScoreDesc(b.GameOver.score);	
    ...
    b.GameOver = e;
    e.prototype.__class__ = "findBomb.GameOver"
})(findBomb || (findBomb = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.initGameScene = function() {
            ...
            b.GameScene.bombs = [];
            b.GameScene.currentLevel = 1;
            b.GameScene.gameTime = 60;
            b.GameScene.canBeTouch = !1;
        ...
        a.createGameContainer = function() {
            ...
            b.GameScene.bgContainer.graphics.beginFill(15987699);
            ...
            b.GameScene.levelLabel = b.GameScene.createTextField();
            b.GameScene.levelLabel.textColor = 0;
            b.GameScene.levelLabel.text = String(b.GameScene.currentLevel);
            b.GameScene.levelLabel.size = 40;
            b.GameScene.levelLabel.x = 130;
            b.GameScene.levelLabel.y = 25;
            b.GameScene.bgContainer.addChild(b.GameScene.levelLabel);
            b.GameScene.timerLabel = b.GameScene.createTextField();
            b.GameScene.timerLabel.textColor = 0;
            b.GameScene.timerLabel.text = String(b.GameScene.gameTime);
            b.GameScene.timerLabel.size = 40;
            b.GameScene.timerLabel.anchorX = 0;
            b.GameScene.timerLabel.x = b.GameScene.winWidth - 80;
            b.GameScene.timerLabel.y =
                25;
            b.GameScene.bgContainer.addChild(b.GameScene.timerLabel);
            b.GameScene.gameTimer = new egret.Timer(1E3, b.GameScene.gameTime);
            b.GameScene.gameTimer.addEventListener(egret.TimerEvent.TIMER, b.GameScene.displayTimer, this);
            b.GameScene.gameTimer.start();
            b.GameScene.createContentGroupByLevel(b.GameScene.currentLevel)
        };
        a.createContentGroupByLevel = function(a) {
            var d = b.GameScene.winWidth - 40,
                e = 0.5 * (b.GameScene.winWidth - d),
                m = 0.5 * (b.GameScene.winHeight - d);
            b.GameScene.contentGroup = new egret.Sprite;
            b.GameScene.contentGroup.x =
                e;
            b.GameScene.contentGroup.y = m + 70;
            b.GameScene.bgContainer.addChild(b.GameScene.contentGroup);
            e = 3;
            e = 1 == a ? 3 : 2 <= a && 3 >= a ? 4 : 4 <= a && 7 >= a ? 5 : 8 <= a && 13 >= a ? 6 : 7;
            a = d / e;
            b.GameScene.selectIndex = Math.floor(Math.random() * e * e);
            d = a / 250;
            for (m = 0; m < e; m++)
                for (var g = 0; g < e; g++) {
                    var f = m * e + g,
                        h = !1;
                    f == b.GameScene.selectIndex && (h = !0);
                    f = new b.BombCell(h, 6, f);
                    f.anchorX = 0;
                    f.anchorY = 0;
                    f.x = g * a + 0.5 * a;
                    f.y = m * a + 0.5 * a;
                    f.scaleX = d;
                    f.scaleY = d;
                    b.GameScene.contentGroup.addChild(f);
                    f.startCount();
                    f.addEventListener(BombEvent.DATE, b.GameScene.bombCountDownEvent,
                        this);
                    f.addEventListener(egret.TouchEvent.TOUCH_BEGIN, b.GameScene.cellDown, f);
                    b.GameScene.bombs.push(f)
                }
            b.GameScene.canBeTouch = !0
        };
        a.cellDown = function(a) {
            b.GameScene.canBeTouch && (a.target.identifier == b.GameScene.selectIndex ? b.GameScene.levelWin() : (b.GameScene.gameTime--, b.GameScene.timerLabel.text = String(b.GameScene.gameTime), 0 == b.GameScene.gameTime && b.GameScene.gameOver()))
        };
        a.levelWin = function() {
            b.GameScene.cleanContentGroup();
            b.GameScene.currentLevel++;
            b.GameScene.levelLabel.text = String(b.GameScene.currentLevel);
            b.GameScene.createContentGroupByLevel(b.GameScene.currentLevel)
        };
        a.cleanContentGroup = function() {
            for (var a = 0; a < b.GameScene.bombs.length; a++) {
                var d = b.GameScene.bombs[a];
                d.removeSelf();
                b.GameScene.contentGroup.removeChild(d)
            }
            b.GameScene.bombs = [];
            b.GameScene.bgContainer.removeChild(b.GameScene.contentGroup)
        };
        a.bombCountDownEvent = function(a) {
            b.GameScene.canBeTouch = !1;
            for (var d = 0; d < b.GameScene.bombs.length; d++) b.GameScene.bombs[d].stopCount();
            var e = b.GameScene.bombs[a.bombIdentifier];
            b.GameScene.contentGroup.setChildIndex(e,
                100);
            e.perpareBomb(function() {
                var a = b.GameScene.createBitmapByName("bombImg");
                a.anchorX = 0.5;
                a.anchorY = 0.5;
                a.x = 0.5 * b.GameScene.winWidth;
                a.y = 0.5 * b.GameScene.winHeight;
                a.scaleX = 0.6;
                a.scaleY = 0.6;
                ...
                egret.Tween.get(a).to({
                    ...
                    scaleX: 1,
                    scaleY: 1
                }, 120).to({}, 1E3).call(b.GameScene.gameOver)
            })
        };
        a.displayTimer = function() {
            b.GameScene.gameTime--;
            b.GameScene.timerLabel.text = String(b.GameScene.gameTime);
            0 == b.GameScene.gameTime &&
                b.GameScene.gameOver()
        };
        a.gameOver = function() {
            b.GameScene.gameTimer.stop();
            b.GameScene.gameTimer.removeEventListener(egret.TimerEvent.TIMER, b.GameScene.displayTimer, this);
            b.GameScene.gameTimer = null;
            b.GameScene.cleanContentGroup();
            b.GameScene.gameBg.removeChild(b.GameScene.bgContainer);
            var a = new b.GameOver(b.GameScene.currentLevel - 1);
    ...
    b.GameScene = e;
    e.prototype.__class__ = "findBomb.GameScene"
})(findBomb || (findBomb = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.initMainUI = function() {
            ...
            this.number = 10;
            this.countNum = new b.Number;
            this.countNum.x = 0.5 * this.winWidth;
            this.countNum.y = 0.5 * this.winHeight + 35;
            this.countNum.scaleX = 0.9;
            this.countNum.scaleY = 0.9;
            this.countNum.setNumber(this.number);
            this.bgContain.addChild(this.countNum);
            this.countNumTimer = new egret.Timer(1E3, 0);
            this.countNumTimer.addEventListener(egret.TimerEvent.TIMER,
                this.countEvent, this);
            this.countNumTimer.start();
            ...
            this.startBtn.y = 0.72 * this.winHeight;
        ...
        a.prototype.initLoadingView = function() {
            ...
            b.graphics.drawRect(0, 0, this.stage.stageWidth, this.stage.stageHeight);
            b.graphics.endFill();
            this.addChild(b);
            ...
            egret.Tween.get(this.loadingLogo).to({},
                1E3).to({
                alpha: 0.2
            }, 1E3).call(function() {
                a.removeChild(b);
        ...
        a.prototype.countEvent = function() {
            this.number--;
            this.countNum.setNumber(this.number);
            0 == this.number && (this.number = 11)
        };
        a.prototype.gameStart = function() {
            this.countNumTimer.stop();
            this.countNumTimer.removeEventListener(egret.TimerEvent.TIMER, this.countEvent, this);
            this.countNumTimer = null;
            this.bgContain.removeChild(this.countNum);
            this.countNum.removeSelf();
            this.countNum = null;
    ...
    b.MainMenu = e;
    e.prototype.__class__ = "findBomb.MainMenu"
})(findBomb || (findBomb = {}));
var __extends = this.__extends || function(b, e) {
        function d() {
            this.constructor = b

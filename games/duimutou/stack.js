...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duimutou/icon.png",
		url: "http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注悠狐阁:Fox_Jacob"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duimutou/i/icon.png';
	lineLink = 'http://foxjacob.wicp.vip:6688/res/plugins/games/GameStation/games/duimutou';

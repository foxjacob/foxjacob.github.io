...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxData = {
                "appId": "", // 服务号可以填写appId
                "imgUrl" : 'http://www.xiyo8.cn/html5/game/duolao/460.jpg',
                "link" : 'http://www.xiyo8.cn/html5/game/duolao/',
                "desc" : text,
                "title" : '来比记忆力'
            };
            ...
            var wxCallbacks = {
                ...
                confirm : function(resp) {
                    ...
                    window.location.href='http://www.xiyo8.cn';
                    // alert("分享成功");
                },
                // 整个分享过程结束
                all : function(resp) {
                    ...
                    if(window.location) window.location.href = "http://www.xiyo8.cn";
                }
            };

...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="'+bt.URL.root+'/dqe/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	onlyH.prototype = {
		...
		,getScreenOption: function(){
			return {
				id: "bt-h-scrren"
				,html: "<table><tr><td><img class='bt-h-screen-img' src='"+bt.URL.root+"/dqe/bt-play-h-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		,getScreenOption: function(){
			return {
				id: "bt-v-scrren"
				,html: "<table><tr><td><img class='bt-v-screen-img' src='"+bt.URL.root+"/dqe/bt-play-v-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
